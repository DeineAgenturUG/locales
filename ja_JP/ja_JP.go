...
func New() locales.Translator {
	return &ja_JP{
		...
		timezones:              map[string]string{"HAST": "ハワイ・アリューシャン標準時", "UYST": "ウルグアイ夏時間", "WART": "西部アルゼンチン標準時", "PDT": "アメリカ太平洋夏時間", "HEPM": "サンピエール島・ミクロン島夏時間", "AST": "大西洋標準時", "ADT": "大西洋夏時間", "HEOG": "グリーンランド西部夏時間", "WITA": "インドネシア中部時間", "CDT": "アメリカ中部夏時間", "AWDT": "オーストラリア西部夏時間", "HKT": "香港標準時", "HNT": "ニューファンドランド標準時", "AKDT": "アラスカ夏時間", "ACST": "オーストラリア中部標準時", "COT": "コロンビア標準時", "HNOG": "グリーンランド西部標準時", "HNEG": "グリーンランド東部標準時", "HNPM": "サンピエール島・ミクロン島標準時", "CST": "アメリカ中部標準時", "MYT": "マレーシア時間", "HEPMX": "メキシコ太平洋夏時間", "CLT": "チリ標準時", "COST": "コロンビア夏時間", "PST": "アメリカ太平洋標準時", "WEZ": "西ヨーロッパ標準時", "LHST": "ロードハウ標準時", "OEZ": "東ヨーロッパ標準時", "HNNOMX": "メキシコ北西部標準時", "BOT": "ボリビア時間", "∅∅∅": "ブラジリア夏時間", "LHDT": "ロードハウ夏時間", "MST": "マカオ標準時", "AEDT": "オーストラリア東部夏時間", "HKST": "香港夏時間", "HAT": "ニューファンドランド夏時間", "ChST": "チャモロ時間", "CLST": "チリ夏時間", "MDT": "マカオ夏時間", "AWST": "オーストラリア西部標準時", "SGT": "シンガポール標準時", "OESZ": "東ヨーロッパ夏時間", "JST": "日本標準時", "WIB": "インドネシア西部時間", "GFT": "仏領ギアナ時間", "EST": "アメリカ東部標準時", "UYT": "ウルグアイ標準時", "WAT": "西アフリカ標準時", "WAST": "西アフリカ夏時間", "ACWST": "オーストラリア中西部標準時", "ACWDT": "オーストラリア中西部夏時間", "GYT": "ガイアナ時間", "TMT": "トルクメニスタン標準時", "EAT": "東アフリカ時間", "HNCU": "キューバ標準時", "ART": "アルゼンチン標準時", "SRT": "スリナム時間", "SAST": "南アフリカ標準時", "BT": "ブータン時間", "AEST": "オーストラリア東部標準時", "WIT": "インドネシア東部時間", "TMST": "トルクメニスタン夏時間", "WARST": "西部アルゼンチン夏時間", "MESZ": "中央ヨーロッパ夏時間", "CAT": "中央アフリカ時間", "WESZ": "西ヨーロッパ夏時間", "EDT": "アメリカ東部夏時間", "GMT": "グリニッジ標準時", "ARST": "アルゼンチン夏時間", "ACDT": "オーストラリア中部夏時間", "CHADT": "チャタム夏時間", "JDT": "日本夏時間", "NZDT": "ニュージーランド夏時間", "HEEG": "グリーンランド東部夏時間", "IST": "インド標準時", "HADT": "ハワイ・アリューシャン夏時間", "HNPMX": "メキシコ太平洋標準時", "ECT": "エクアドル時間", "HENOMX": "メキシコ北西部夏時間", "NZST": "ニュージーランド標準時", "VET": "ベネズエラ時間", "HECU": "キューバ夏時間", "AKST": "アラスカ標準時", "MEZ": "中央ヨーロッパ標準時", "CHAST": "チャタム標準時"},
	}
}
