...
func New() locales.Translator {
	return &pl{
		...
		timezones:              map[string]string{"EST": "czas wschodnioamerykański standardowy", "HNOG": "Grenlandia Zachodnia (czas standardowy)", "CHAST": "Chatham (czas standardowy)", "BOT": "Boliwia", "WAT": "czas zachodnioafrykański standardowy", "ECT": "Ekwador", "∅∅∅": "Azory (czas letni)", "VET": "Wenezuela", "MDT": "czas górski letni", "MEZ": "czas środkowoeuropejski standardowy", "OESZ": "czas wschodnioeuropejski letni", "HEPM": "Saint-Pierre i Miquelon (czas letni)", "HKT": "Hongkong (czas standardowy)", "WARST": "Argentyna Zachodnia (czas letni)", "HNT": "Nowa Fundlandia (czas standardowy)", "HNEG": "Grenlandia Wschodnia (czas standardowy)", "AKDT": "Alaska (czas letni)", "WESZ": "czas zachodnioeuropejski letni", "AEST": "czas wschodnioaustralijski standardowy", "HEOG": "Grenlandia Zachodnia (czas letni)", "HAST": "Hawaje-Aleuty (czas standardowy)", "CAT": "czas środkowoafrykański", "CDT": "czas środkowoamerykański letni", "UYST": "Urugwaj (czas letni)", "HKST": "Hongkong (czas letni)", "EAT": "czas wschodnioafrykański", "OEZ": "czas wschodnioeuropejski standardowy", "WART": "Argentyna Zachodnia (czas standardowy)", "ARST": "Argentyna (czas letni)", "HADT": "Hawaje-Aleuty (czas letni)", "CLT": "Chile (czas standardowy)", "ADT": "czas atlantycki letni", "TMST": "Turkmenistan (czas letni)", "SAST": "czas południowoafrykański", "ART": "Argentyna (czas standardowy)", "ChST": "Czamorro", "GFT": "Gujana Francuska", "UYT": "Urugwaj (czas standardowy)", "ACWDT": "czas środkowo-zachodnioaustralijski letni", "TMT": "Turkmenistan (czas standardowy)", "NZST": "Nowa Zelandia (czas standardowy)", "CLST": "Chile (czas letni)", "PDT": "czas pacyficzny letni", "ACDT": "czas środkowoaustralijski letni", "GMT": "czas uniwersalny", "HECU": "Kuba (czas letni)", "HNNOMX": "Meksyk Północno-Zachodni (czas standardowy)", "WIT": "Indonezja Wschodnia", "WITA": "Indonezja Środkowa", "EDT": "czas wschodnioamerykański letni", "MYT": "Malezja", "COT": "Kolumbia (czas standardowy)", "AST": "czas atlantycki standardowy", "AWST": "czas zachodnioaustralijski standardowy", "PST": "czas pacyficzny standardowy", "MESZ": "czas środkowoeuropejski letni", "ACST": "czas środkowoaustralijski standardowy", "WEZ": "czas zachodnioeuropejski standardowy", "WIB": "Indonezja Zachodnia", "AWDT": "czas zachodnioaustralijski letni", "NZDT": "Nowa Zelandia (czas letni)", "LHDT": "Lord Howe (czas letni)", "SRT": "Surinam", "JST": "Japonia (czas standardowy)", "HENOMX": "Meksyk Północno-Zachodni (czas letni)", "HNCU": "Kuba (czas standardowy)", "HEEG": "Grenlandia Wschodnia (czas letni)", "BT": "Bhutan", "IST": "czas indyjski standardowy", "CST": "czas środkowoamerykański standardowy", "ACWST": "czas środkowo-zachodnioaustralijski standardowy", "AEDT": "czas wschodnioaustralijski letni", "MST": "czas górski standardowy", "HNPMX": "Meksyk (czas pacyficzny standardowy)", "LHST": "Lord Howe (czas standardowy)", "WAST": "czas zachodnioafrykański letni", "HAT": "Nowa Fundlandia (czas letni)", "CHADT": "Chatham (czas letni)", "HNPM": "Saint-Pierre i Miquelon (czas standardowy)", "HEPMX": "Meksyk (czas pacyficzny letni)", "AKST": "Alaska (czas standardowy)", "COST": "Kolumbia (czas letni)", "GYT": "Gujana", "SGT": "Singapur", "JDT": "Japonia (czas letni)"},
	}
}
