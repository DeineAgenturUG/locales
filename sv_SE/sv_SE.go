...
func New() locales.Translator {
	return &sv_SE{
		...
		timezones:              map[string]string{"EST": "östnordamerikansk normaltid", "WARST": "västargentinsk sommartid", "AKDT": "Alaska, sommartid", "WAT": "västafrikansk normaltid", "ACWST": "västcentralaustralisk normaltid", "GYT": "Guyanatid", "ADT": "nordamerikansk atlantsommartid", "OEZ": "östeuropeisk normaltid", "ART": "östargentinsk normaltid", "CDT": "centralnordamerikansk sommartid", "HAST": "Honolulu, normaltid", "GMT": "Greenwichtid", "MESZ": "centraleuropeisk sommartid", "WAST": "västafrikansk sommartid", "ACWDT": "västcentralaustralisk sommartid", "HNPMX": "mexikansk stillahavstid, normaltid", "WITA": "centralindonesisk tid", "TMT": "turkmensk normaltid", "WART": "västargentinsk normaltid", "HAT": "Newfoundland, sommartid", "WESZ": "västeuropeisk sommartid", "HADT": "Honolulu, sommartid", "AST": "nordamerikansk atlantnormaltid", "HNOG": "västgrönländsk normaltid", "HEOG": "västgrönländsk sommartid", "SGT": "Singaporetid", "WIT": "östindonesisk tid", "EAT": "östafrikansk tid", "HNNOMX": "nordvästmexikansk normaltid", "WIB": "västindonesisk tid", "VET": "venezuelansk tid", "HENOMX": "nordvästmexikansk sommartid", "HEPM": "S:t Pierre och Miquelon, sommartid", "HEPMX": "mexikansk stillahavstid, sommartid", "JDT": "japansk sommartid", "SAST": "sydafrikansk tid", "AEDT": "östaustralisk sommartid", "HEEG": "östgrönländsk sommartid", "CHAST": "Chatham, normaltid", "CHADT": "Chatham, sommartid", "WEZ": "västeuropeisk normaltid", "MYT": "malaysisk tid", "AWST": "västaustralisk normaltid", "NZDT": "nyzeeländsk sommartid", "PST": "västnordamerikansk normaltid", "SRT": "Surinamtid", "MDT": "Macausommartid", "∅∅∅": "Brasilia, sommartid", "UYST": "uruguayansk sommartid", "HECU": "kubansk sommartid", "HNT": "Newfoundland, normaltid", "UYT": "uruguayansk normaltid", "CLT": "chilensk normaltid", "ECT": "ecuadoriansk tid", "AEST": "östaustralisk normaltid", "AWDT": "västaustralisk sommartid", "HKT": "Hongkong, normaltid", "HKST": "Hongkong, sommartid", "AKST": "Alaska, normaltid", "EDT": "östnordamerikansk sommartid", "CLST": "chilensk sommartid", "COT": "colombiansk normaltid", "JST": "japansk normaltid", "PDT": "västnordamerikansk sommartid", "HNEG": "östgrönländsk normaltid", "ACDT": "centralaustralisk sommartid", "CST": "centralnordamerikansk normaltid", "LHST": "Lord Howe, normaltid", "LHDT": "Lord Howe, sommartid", "GFT": "Franska Guyanatid", "COST": "colombiansk sommartid", "OESZ": "östeuropeisk sommartid", "BOT": "boliviansk tid", "MEZ": "centraleuropeisk normaltid", "HNPM": "S:t Pierre och Miquelon, normaltid", "ChST": "Chamorrotid", "MST": "Macaunormaltid", "TMST": "turkmensk sommartid", "NZST": "nyzeeländsk normaltid", "HNCU": "kubansk normaltid", "ARST": "östargentinsk sommartid", "CAT": "centralafrikansk tid", "BT": "bhutansk tid", "ACST": "centralaustralisk normaltid", "IST": "indisk tid"},
	}
}
