...
func New() locales.Translator {
	return &he{
		...
		timezones:              map[string]string{"HNEG": "שעון מזרח גרינלנד (חורף)", "BOT": "שעון בוליביה", "EST": "שעון החוף המזרחי (חורף)", "GMT": "שעון גריניץ׳\u200f", "HAST": "שעון האיים האלאוטיים הוואי (חורף)", "ChST": "שעון צ׳אמורו", "UYT": "שעון אורוגוואי (חורף)", "CLST": "שעון צ׳ילה (קיץ)", "AEST": "שעון מזרח אוסטרליה (חורף)", "SGT": "שעון סינגפור", "PST": "שעון מערב ארה״ב (חורף)", "CHAST": "שעון צ׳טהאם (חורף)", "ACWDT": "שעון מרכז-מערב אוסטרליה (קיץ)", "MDT": "שעון קיץ מקאו", "HKT": "שעון הונג קונג (חורף)", "HNCU": "שעון קובה (חורף)", "ACST": "שעון מרכז אוסטרליה (חורף)", "LHST": "שעון אי הלורד האו (חורף)", "HNPMX": "שעון מערב מקסיקו (חורף)", "ADT": "שעון האוקיינוס האטלנטי (קיץ)", "AWDT": "שעון מערב אוסטרליה (קיץ)", "NZDT": "שעון ניו זילנד (קיץ)", "WIB": "שעון מערב אינדונזיה", "CST": "שעון מרכז ארה״ב (חורף)", "COST": "שעון קולומביה (קיץ)", "WAST": "שעון מערב אפריקה (קיץ)", "WARST": "שעון מערב ארגנטינה (קיץ)", "CLT": "שעון צ׳ילה (חורף)", "CAT": "שעון מרכז אפריקה", "ACDT": "שעון מרכז אוסטרליה (קיץ)", "JDT": "שעון יפן (קיץ)", "TMT": "שעון טורקמניסטן (חורף)", "OESZ": "שעון מזרח אירופה (קיץ)", "MEZ": "שעון מרכז אירופה (חורף)", "ARST": "שעון ארגנטינה (קיץ)", "CHADT": "שעון צ׳טהאם (קיץ)", "AEDT": "שעון מזרח אוסטרליה (קיץ)", "WESZ": "שעון מערב אירופה (קיץ)", "AST": "שעון האוקיינוס האטלנטי (חורף)", "WIT": "שעון מזרח אינדונזיה", "HKST": "שעון הונג קונג (קיץ)", "HECU": "שעון קובה (קיץ)", "NZST": "שעון ניו זילנד (חורף)", "HEPM": "שעון סנט פייר ומיקלון (קיץ)", "CDT": "שעון מרכז ארה״ב (קיץ)", "WAT": "שעון מערב אפריקה (חורף)", "∅∅∅": "שעון האיים האזוריים (קיץ)", "OEZ": "שעון מזרח אירופה (חורף)", "PDT": "שעון מערב ארה״ב (קיץ)", "HEEG": "שעון מזרח גרינלנד (קיץ)", "SAST": "שעון דרום אפריקה", "WEZ": "שעון מערב אירופה (חורף)", "VET": "שעון ונצואלה", "HNOG": "שעון מערב גרינלנד (חורף)", "HEOG": "שעון מערב גרינלנד (קיץ)", "EAT": "שעון מזרח אפריקה", "WART": "שעון מערב ארגנטינה (חורף)", "HENOMX": "שעון צפון-מערב מקסיקו (קיץ)", "HNT": "שעון ניופאונדלנד (חורף)", "AKST": "שעון אלסקה (חורף)", "IST": "שעון הודו", "AKDT": "שעון אלסקה (קיץ)", "ART": "שעון ארגנטינה (חורף)", "MYT": "שעון מלזיה", "GYT": "שעון גיאנה", "HAT": "שעון ניופאונדלנד (קיץ)", "GFT": "שעון גיאנה הצרפתית", "SRT": "שעון סורינאם", "HNNOMX": "שעון צפון-מערב מקסיקו (חורף)", "MESZ": "שעון מרכז אירופה (קיץ)", "HADT": "שעון האיים האלאוטיים הוואי (קיץ)", "HEPMX": "שעון מערב מקסיקו (קיץ)", "ACWST": "שעון מרכז-מערב אוסטרליה (חורף)", "ECT": "שעון אקוודור", "JST": "שעון יפן (חורף)", "HNPM": "שעון סנט פייר ומיקלון (חורף)", "BT": "שעון בהוטן", "EDT": "שעון החוף המזרחי (קיץ)", "LHDT": "שעון אי הלורד האו (קיץ)", "COT": "שעון קולומביה (חורף)", "AWST": "שעון מערב אוסטרליה (חורף)", "TMST": "שעון טורקמניסטן (קיץ)", "WITA": "שעון מרכז אינדונזיה", "UYST": "שעון אורוגוואי (קיץ)", "MST": "שעון חורף מקאו"},
	}
}
