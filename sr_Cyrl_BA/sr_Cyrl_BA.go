...
func New() locales.Translator {
	return &sr_Cyrl_BA{
		...
		timezones:              map[string]string{"WIT": "Источно-индонезијско време", "CAT": "Централно-афричко време", "ACDT": "Аустралијско централно летње време", "HAST": "Хавајско-алеутско стандардно време", "HADT": "Хавајско-алеутско летње време", "ACWST": "Аустралијско централно западно стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "AKDT": "Аљаска, летње време", "EDT": "Северноамеричко источно летње време", "OEZ": "Источноевропско стандардно време", "JDT": "Јапанско летње време", "MEZ": "Средњеевропско стандардно време", "HENOMX": "Северозападни Мексико, летње време", "HNEG": "Источни Гренланд, стандардно време", "CLT": "Чиле, стандардно време", "COST": "Колумбија, летње време", "ADT": "Атлантско летње време", "HKT": "Хонг Конг, стандардно време", "NZST": "Нови Зеланд, стандардно време", "VET": "Венецуела време", "AKST": "Аљаска, стандардно време", "IST": "Индијско стандардно време", "EST": "Северноамеричко источно стандардно време", "∅∅∅": "Акре летње рачунање времена", "UYT": "Уругвај, стандардно време", "GMT": "Средње време по Гриничу", "JST": "Јапанско стандардно време", "MESZ": "Средњеевропско летње време", "LHST": "Лорд Хов, стандардно време", "MYT": "Малезија време", "UYST": "Уругвај, летње време", "WAT": "Западно-афричко стандардно време", "SRT": "Суринам време", "HNOG": "Западни Гренланд, стандардно време", "HNNOMX": "Северозападни Мексико, стандардно време", "WIB": "Западно-индонезијско време", "GYT": "Гвајана време", "HECU": "Куба, летње време", "PST": "Северноамеричко пацифичко стандардно време", "BOT": "Боливија време", "CHADT": "Чатам, летње време", "TMST": "Туркменистан, летње време", "WART": "Западна Аргентина, стандардно време", "CHAST": "Чатам, стандардно време", "HNPM": "Сен Пјер и Микелон, стандардно време", "HNT": "Њуфаундленд, стандардно време", "WAST": "Западно-афричко летње време", "CLST": "Чиле, летње време", "HEPMX": "Мексички Пацифик, летње време", "ARST": "Аргентина, летње време", "WESZ": "Западноевропско летње време", "GFT": "Француска Гвајана време", "AST": "Атлантско стандардно време", "OESZ": "Источноевропско летње време", "NZDT": "Нови Зеланд, летње време", "ACST": "Аустралијско централно стандардно време", "CDT": "Северноамеричко централно летње време", "AWDT": "Аустралијско западно летње време", "HKST": "Хонг Конг, летње време", "EAT": "Источно-афричко време", "LHDT": "Лорд Хов, летње време", "HAT": "Њуфаундленд, летње време", "HEEG": "Источни Гренланд, летње време", "ChST": "Чаморо време", "ECT": "Еквадор време", "AEST": "Аустралијско источно стандардно време", "HEOG": "Западни Гренланд, летње време", "AWST": "Аустралијско западно стандардно време", "SAST": "Јужно-афричко време", "MST": "Макао стандардно време", "TMT": "Туркменистан, стандардно време", "ART": "Аргентина, стандардно време", "BT": "Бутан време", "WEZ": "Западноевропско стандардно време", "COT": "Колумбија, стандардно време", "SGT": "Сингапур, стандардно време", "WARST": "Западна Аргентина, летње време", "HEPM": "Сен Пјер и Микелон, летње време", "CST": "Северноамеричко централно стандардно време", "ACWDT": "Аустралијско централно западно летње време", "MDT": "Макао летње рачунање времена", "AEDT": "Аустралијско источно летње време", "WITA": "Централно-индонезијско време", "HNCU": "Куба, стандардно време", "PDT": "Северноамеричко пацифичко летње време"},
	}
}
