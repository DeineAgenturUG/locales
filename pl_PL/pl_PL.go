...
func New() locales.Translator {
	return &pl_PL{
		...
		timezones:              map[string]string{"WIB": "Indonezja Zachodnia", "HNOG": "Grenlandia Zachodnia (czas standardowy)", "AWDT": "czas zachodnioaustralijski letni", "CLT": "Chile (czas standardowy)", "COT": "Kolumbia (czas standardowy)", "COST": "Kolumbia (czas letni)", "AEDT": "czas wschodnioaustralijski letni", "HNEG": "Grenlandia Wschodnia (czas standardowy)", "AKST": "Alaska (czas standardowy)", "ACDT": "czas środkowoaustralijski letni", "ACWST": "czas środkowo-zachodnioaustralijski standardowy", "WART": "Argentyna Zachodnia (czas standardowy)", "HKST": "Hongkong (czas letni)", "JDT": "Japonia (czas letni)", "HNPM": "Saint-Pierre i Miquelon (czas standardowy)", "ChST": "Czamorro", "ACWDT": "czas środkowo-zachodnioaustralijski letni", "MDT": "MDT", "EST": "czas wschodnioamerykański standardowy", "LHST": "Lord Howe (czas standardowy)", "∅∅∅": "Brasília (czas letni)", "HEOG": "Grenlandia Zachodnia (czas letni)", "MEZ": "czas środkowoeuropejski standardowy", "CHAST": "Chatham (czas standardowy)", "CDT": "czas środkowoamerykański letni", "WEZ": "czas zachodnioeuropejski standardowy", "WAT": "czas zachodnioafrykański standardowy", "AKDT": "Alaska (czas letni)", "HEPMX": "Meksyk (czas pacyficzny letni)", "HKT": "Hongkong (czas standardowy)", "SGT": "Singapur", "NZDT": "Nowa Zelandia (czas letni)", "PST": "czas pacyficzny standardowy", "ADT": "czas atlantycki letni", "TMST": "Turkmenistan (czas letni)", "EAT": "czas wschodnioafrykański", "OESZ": "czas wschodnioeuropejski letni", "CST": "czas środkowoamerykański standardowy", "UYST": "Urugwaj (czas letni)", "CLST": "Chile (czas letni)", "ECT": "Ekwador", "HENOMX": "Meksyk Północno-Zachodni (czas letni)", "BOT": "Boliwia", "HADT": "Hawaje-Aleuty (czas letni)", "WIT": "Indonezja Wschodnia", "WARST": "Argentyna Zachodnia (czas letni)", "WAST": "czas zachodnioafrykański letni", "MST": "MST", "HEEG": "Grenlandia Wschodnia (czas letni)", "WESZ": "czas zachodnioeuropejski letni", "EDT": "czas wschodnioamerykański letni", "HAST": "Hawaje-Aleuty (czas standardowy)", "ARST": "Argentyna (czas letni)", "HNPMX": "Meksyk (czas pacyficzny standardowy)", "GYT": "Gujana", "SRT": "Surinam", "JST": "Japonia (czas standardowy)", "HAT": "Nowa Fundlandia (czas letni)", "MESZ": "czas środkowoeuropejski letni", "HEPM": "Saint-Pierre i Miquelon (czas letni)", "MYT": "Malezja", "NZST": "Nowa Zelandia (czas standardowy)", "ART": "Argentyna (czas standardowy)", "AWST": "czas zachodnioaustralijski standardowy", "VET": "Wenezuela", "GFT": "Gujana Francuska", "TMT": "Turkmenistan (czas standardowy)", "PDT": "czas pacyficzny letni", "GMT": "czas uniwersalny", "AST": "czas atlantycki standardowy", "OEZ": "czas wschodnioeuropejski standardowy", "WITA": "Indonezja Środkowa", "SAST": "czas południowoafrykański", "BT": "Bhutan", "CHADT": "Chatham (czas letni)", "IST": "czas indyjski standardowy", "HECU": "Kuba (czas letni)", "UYT": "Urugwaj (czas standardowy)", "AEST": "czas wschodnioaustralijski standardowy", "HNCU": "Kuba (czas standardowy)", "HNNOMX": "Meksyk Północno-Zachodni (czas standardowy)", "HNT": "Nowa Fundlandia (czas standardowy)", "CAT": "czas środkowoafrykański", "ACST": "czas środkowoaustralijski standardowy", "LHDT": "Lord Howe (czas letni)"},
	}
}
