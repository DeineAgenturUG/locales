...
func New() locales.Translator {
	return &hu{
		...
		timezones:              map[string]string{"CAT": "közép-afrikai téli idő", "HEPMX": "mexikói csendes-óceáni nyári idő", "MDT": "Macaui nyári idő", "OESZ": "kelet-európai nyári idő", "HNEG": "kelet-grönlandi téli idő", "ACST": "közép-ausztráliai téli idő", "COST": "kolumbiai nyári idő", "HNNOMX": "északnyugat-mexikói zónaidő", "VET": "venezuelai idő", "SAST": "dél-afrikai téli idő", "LHST": "Lord Howe-szigeti téli idő", "HKT": "hongkongi téli idő", "NZDT": "új-zélandi nyári idő", "MEZ": "közép-európai téli idő", "HNPMX": "mexikói csendes-óceáni zónaidő", "ACWST": "közép-nyugat-ausztráliai téli idő", "HEOG": "nyugat-grönlandi nyári idő", "EAT": "kelet-afrikai téli idő", "EDT": "keleti államokbeli nyári idő", "HAST": "hawaii-aleuti téli idő", "GFT": "francia-guyanai idő", "AWDT": "nyugat-ausztráliai nyári idő", "TMST": "türkmenisztáni nyári idő", "HECU": "kubai nyári idő", "UYST": "uruguayi nyári idő", "GMT": "greenwichi középidő, téli idő", "GYT": "guyanai téli idő", "PDT": "csendes-óceáni nyári idő", "CDT": "középső államokbeli nyári idő", "WAST": "nyugat-afrikai nyári idő", "SRT": "szurinámi idő", "HEEG": "kelet-grönlandi nyári idő", "AKDT": "alaszkai nyári idő", "EST": "keleti államokbeli zónaidő", "COT": "kolumbiai téli idő", "AEDT": "kelet-ausztráliai nyári idő", "AWST": "nyugat-ausztráliai téli idő", "PST": "csendes-óceáni zónaidő", "HAT": "új-fundlandi nyári idő", "BT": "butáni idő", "CST": "középső államokbeli zónaidő", "WIB": "nyugat-indonéziai téli idő", "AST": "atlanti-óceáni zónaidő", "WIT": "kelet-indonéziai idő", "OEZ": "kelet-európai téli idő", "JST": "japán téli idő", "WARST": "nyugat-argentínai nyári idő", "CHADT": "chathami nyári idő", "CLT": "chilei téli idő", "WAT": "nyugat-afrikai téli idő", "ACWDT": "közép-nyugat-ausztráliai nyári idő", "NZST": "új-zélandi téli idő", "ART": "argentínai téli idő", "ARST": "argentínai nyári idő", "HNPM": "Saint-Pierre és Miquelon-i zónaidő", "WESZ": "nyugat-európai nyári idő", "HADT": "hawaii-aleuti nyári idő", "HNOG": "nyugat-grönlandi téli idő", "SGT": "szingapúri téli idő", "WITA": "közép-indonéziai idő", "JDT": "japán nyári idő", "ChST": "chamorrói téli idő", "UYT": "uruguayi téli idő", "MESZ": "közép-európai nyári idő", "ACDT": "közép-ausztráliai nyári idő", "CHAST": "chathami téli idő", "IST": "indiai téli idő", "WEZ": "nyugat-európai téli idő", "LHDT": "Lord Howe-szigeti nyári idő", "CLST": "chilei nyári idő", "MST": "Macaui zónaidő", "HNCU": "kubai téli idő", "TMT": "türkmenisztáni téli idő", "BOT": "bolíviai téli idő", "WART": "nyugat-argentínai téli idő", "HENOMX": "északnyugat-mexikói nyári idő", "HNT": "új-fundlandi zónaidő", "AKST": "alaszkai zónaidő", "MYT": "malajziai idő", "ADT": "atlanti-óceáni nyári idő", "AEST": "kelet-ausztráliai téli idő", "HEPM": "Saint-Pierre és Miquelon-i nyári idő", "∅∅∅": "brazíliai nyári idő", "ECT": "ecuadori téli idő", "HKST": "hongkongi nyári idő"},
	}
}
