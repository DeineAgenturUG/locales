...
func New() locales.Translator {
	return &sr_Latn_RS{
		...
		timezones:              map[string]string{"WIT": "Источно-индонезијско време", "TMT": "Туркменистан, стандардно време", "ACDT": "Аустралијско централно летње време", "HAST": "Хавајско-алеутско стандардно време", "ACWDT": "Аустралијско централно западно летње време", "SGT": "Сингапур, стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "AKDT": "Аљаска, летње време", "GMT": "Средње време по Гриничу", "GYT": "Гвајана време", "AEST": "Аустралијско источно стандардно време", "AEDT": "Аустралијско источно летње време", "TMST": "Туркменистан, летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "MST": "Макао стандардно време", "HNOG": "Западни Гренланд, стандардно време", "HEOG": "Западни Гренланд, летње време", "EAT": "Источно-афричко време", "HECU": "Куба, летње време", "LHST": "Лорд Хов, стандардно време", "COT": "Колумбија, стандардно време", "ECT": "Еквадор време", "AST": "Атлантско стандардно време", "CHAST": "Чатам, стандардно време", "AWDT": "Аустралијско западно летње време", "OESZ": "Источноевропско летње време", "WART": "Западна Аргентина, стандардно време", "VET": "Венецуела време", "HNEG": "Источни Гренланд, стандардно време", "GFT": "Француска Гвајана време", "CLST": "Чиле, летње време", "COST": "Колумбија, летње време", "SRT": "Суринам време", "UYST": "Уругвај, летње време", "HEEG": "Источни Гренланд, летње време", "ART": "Аргентина, стандардно време", "ACST": "Аустралијско централно стандардно време", "CST": "Северноамеричко централно стандардно време", "ChST": "Чаморо време", "WARST": "Западна Аргентина, летње време", "NZST": "Нови Зеланд, стандардно време", "NZDT": "Нови Зеланд, летње време", "CDT": "Северноамеричко централно летње време", "LHDT": "Лорд Хов, летње време", "HKT": "Хонг Конг, стандардно време", "JST": "Јапанско стандардно време", "HENOMX": "Северозападни Мексико, летње време", "HNT": "Њуфаундленд, стандардно време", "WIB": "Западно-индонезијско време", "IST": "Индијско стандардно време", "CLT": "Чиле, стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "PDT": "Северноамеричко пацифичко летње време", "MEZ": "Средњеевропско стандардно време", "MESZ": "Средњеевропско летње време", "BT": "Бутан време", "EST": "Северноамеричко источно стандардно време", "HKST": "Хонг Конг, летње време", "HNNOMX": "Северозападни Мексико, стандардно време", "BOT": "Боливија време", "SAST": "Јужно-афричко време", "HEPM": "Сен Пјер и Микелон, летње време", "MYT": "Малезија време", "EDT": "Северноамеричко источно летње време", "ADT": "Атлантско летње време", "WITA": "Централно-индонезијско време", "ARST": "Аргентина, летње време", "AKST": "Аљаска, стандардно време", "UYT": "Уругвај, стандардно време", "WAT": "Западно-афричко стандардно време", "WESZ": "Западноевропско летње време", "HADT": "Хавајско-алеутско летње време", "ACWST": "Аустралијско централно западно стандардно време", "HAT": "Њуфаундленд, летње време", "OEZ": "Источноевропско стандардно време", "HNCU": "Куба, стандардно време", "CHADT": "Чатам, летње време", "CAT": "Централно-афричко време", "AWST": "Аустралијско западно стандардно време", "JDT": "Јапанско летње време", "MDT": "Макао летње рачунање времена", "WEZ": "Западноевропско стандардно време", "∅∅∅": "Бразилија, летње време", "HEPMX": "Мексички Пацифик, летње време", "WAST": "Западно-афричко летње време"},
	}
}
