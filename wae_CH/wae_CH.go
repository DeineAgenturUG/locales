...
func New() locales.Translator {
	return &wae_CH{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"HEOG": "HEOG", "MEZ": "Mitteleuropäiši Standardzit", "COST": "COST", "GMT": "GMT", "EAT": "EAT", "TMST": "TMST", "NZST": "NZST", "BOT": "BOT", "ACDT": "ACDT", "LHDT": "LHDT", "MYT": "MYT", "COT": "COT", "∅∅∅": "∅∅∅", "CAT": "CAT", "WESZ": "Wešteuropäiši Summerzit", "HAST": "HAST", "ChST": "ChST", "UYST": "UYST", "HEPMX": "HEPMX", "WART": "WART", "WARST": "WARST", "UYT": "UYT", "SGT": "SGT", "NZDT": "NZDT", "ARST": "ARST", "AEDT": "AEDT", "HKST": "HKST", "JDT": "JDT", "HEEG": "HEEG", "CST": "CST", "CLST": "CLST", "HKT": "HKT", "JST": "JST", "HNNOMX": "HNNOMX", "HENOMX": "HENOMX", "PST": "PST", "HEPM": "HEPM", "GFT": "GFT", "ECT": "ECT", "WITA": "WITA", "HNEG": "HNEG", "CHADT": "CHADT", "WAST": "WAST", "AST": "Atlantiši Standardzit", "HECU": "HECU", "PDT": "PDT", "ACST": "ACST", "LHST": "LHST", "WAT": "WAT", "ACWDT": "ACWDT", "CLT": "CLT", "HNPMX": "HNPMX", "TMT": "TMT", "AKST": "AKST", "ART": "ART", "BT": "BT", "CHAST": "CHAST", "ACWST": "ACWST", "SRT": "SRT", "MDT": "MDT", "WIT": "WIT", "OESZ": "Ošteuropäiši Summerzit", "EST": "EST", "AEST": "AEST", "AWDT": "AWDT", "WEZ": "Wešteuropäiši Standardzit", "HADT": "HADT", "GYT": "GYT", "OEZ": "Ošteuropäiši Standardzit", "HNT": "HNT", "MESZ": "Mitteleuropäiši Summerzit", "HNPM": "HNPM", "IST": "IST", "CDT": "CDT", "WIB": "WIB", "HNOG": "HNOG", "SAST": "SAST", "HAT": "HAT", "AKDT": "AKDT", "MST": "MST", "ADT": "Atlantiši Summerzit", "AWST": "AWST", "VET": "VET", "HNCU": "HNCU", "EDT": "EDT"},
	}
}
