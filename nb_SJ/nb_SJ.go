...
func New() locales.Translator {
	return &nb_SJ{
		...
		timezones:              map[string]string{"MST": "Macau, standardtid", "AST": "normaltid for den nordamerikanske atlanterhavskysten", "WIT": "østindonesisk tid", "CLT": "chilensk normaltid", "HENOMX": "sommertid for nordvestlige Mexico", "HNEG": "østgrønlandsk normaltid", "WEZ": "vesteuropeisk normaltid", "WAT": "vestafrikansk normaltid", "HEOG": "vestgrønlandsk sommertid", "HKT": "normaltid for Hongkong", "HKST": "sommertid for Hongkong", "EAT": "østafrikansk tid", "HNCU": "cubansk normaltid", "HNNOMX": "normaltid for nordvestlige Mexico", "BOT": "boliviansk tid", "EST": "normaltid for den nordamerikanske østkysten", "AEDT": "østaustralsk sommertid", "PDT": "sommertid for den nordamerikanske Stillehavskysten", "HAT": "sommertid for Newfoundland", "MYT": "malaysisk tid", "CLST": "chilensk sommertid", "TMST": "turkmensk sommertid", "WITA": "sentralindonesisk tid", "GYT": "guyansk tid", "ADT": "sommertid for den nordamerikanske atlanterhavskysten", "∅∅∅": "asorisk sommertid", "CHAST": "normaltid for Chatham", "WESZ": "vesteuropeisk sommertid", "UYT": "uruguayansk normaltid", "MDT": "Macau, sommertid", "JDT": "japansk sommertid", "HECU": "cubansk sommertid", "ARST": "argentinsk sommertid", "HEPMX": "sommertid for den meksikanske Stillehavskysten", "SRT": "surinamsk tid", "LHST": "normaltid for Lord Howe-øya", "AEST": "østaustralsk normaltid", "TMT": "turkmensk normaltid", "OEZ": "østeuropeisk normaltid", "OESZ": "østeuropeisk sommertid", "JST": "japansk normaltid", "HEPM": "sommertid for Saint-Pierre-et-Miquelon", "WIB": "vestindonesisk tid", "ChST": "tidssone for Chamorro", "HNPMX": "normaltid for den meksikanske Stillehavskysten", "GMT": "Greenwich middeltid", "AWST": "vestaustralsk normaltid", "HEEG": "østgrønlandsk sommertid", "AKST": "alaskisk normaltid", "MESZ": "sentraleuropeisk sommertid", "IST": "indisk tid", "UYST": "uruguayansk sommertid", "ACWDT": "vest-sentralaustralsk sommertid", "CDT": "sommertid for det sentrale Nord-Amerika", "WART": "vestargentinsk normaltid", "SAST": "sørafrikansk tid", "HNT": "normaltid for Newfoundland", "AKDT": "alaskisk sommertid", "MEZ": "sentraleuropeisk normaltid", "CAT": "sentralafrikansk tid", "CHADT": "sommertid for Chatham", "EDT": "sommertid for den nordamerikanske østkysten", "HAST": "normaltid for Hawaii og Aleutene", "ACWST": "vest-sentralaustralsk normaltid", "SGT": "singaporsk tid", "NZDT": "newzealandsk sommertid", "ART": "argentinsk normaltid", "ACDT": "sentralaustralsk sommertid", "HADT": "sommertid for Hawaii og Aleutene", "ACST": "sentralaustralsk normaltid", "COT": "colombiansk normaltid", "HNOG": "vestgrønlandsk normaltid", "AWDT": "vestaustralsk sommertid", "LHDT": "sommertid for Lord Howe-øya", "GFT": "tidssone for Fransk Guyana", "COST": "colombiansk sommertid", "ECT": "ecuadoriansk tid", "NZST": "newzealandsk normaltid", "VET": "venezuelansk tid", "PST": "normaltid for den nordamerikanske Stillehavskysten", "BT": "bhutansk tid", "CST": "normaltid for det sentrale Nord-Amerika", "WAST": "vestafrikansk sommertid", "WARST": "vestargentinsk sommertid", "HNPM": "normaltid for Saint-Pierre-et-Miquelon"},
	}
}
