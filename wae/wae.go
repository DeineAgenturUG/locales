...
func New() locales.Translator {
	return &wae{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"UYST": "UYST", "WAST": "WAST", "MDT": "MDT", "ECT": "ECT", "ADT": "Atlantiši Summerzit", "TMST": "TMST", "HNCU": "HNCU", "BOT": "BOT", "AEDT": "AEDT", "HEOG": "HEOG", "WITA": "WITA", "CLST": "CLST", "COT": "COT", "AEST": "AEST", "MESZ": "Mitteleuropäiši Summerzit", "ACDT": "ACDT", "CLT": "CLT", "CDT": "CDT", "ChST": "ChST", "JST": "JST", "HENOMX": "HENOMX", "PDT": "PDT", "HEPM": "HEPM", "GMT": "GMT", "AST": "Atlantiši Standardzit", "AKDT": "AKDT", "MEZ": "Mitteleuropäiši Standardzit", "EST": "EST", "HKT": "HKT", "HNEG": "HNEG", "HEEG": "HEEG", "GFT": "GFT", "GYT": "GYT", "SRT": "SRT", "MST": "MST", "HECU": "HECU", "AKST": "AKST", "BT": "BT", "OEZ": "Ošteuropäiši Standardzit", "∅∅∅": "∅∅∅", "ARST": "ARST", "CHADT": "CHADT", "WEZ": "Wešteuropäiši Standardzit", "AWST": "AWST", "AWDT": "AWDT", "HKST": "HKST", "WESZ": "Wešteuropäiši Summerzit", "WAT": "WAT", "ACWST": "ACWST", "HNT": "HNT", "CAT": "CAT", "CST": "CST", "WIB": "WIB", "HAST": "HAST", "SGT": "SGT", "TMT": "TMT", "NZST": "NZST", "ACWDT": "ACWDT", "COST": "COST", "UYT": "UYT", "EAT": "EAT", "WARST": "WARST", "IST": "IST", "EDT": "EDT", "LHST": "LHST", "HADT": "HADT", "HNOG": "HNOG", "PST": "PST", "HAT": "HAT", "HNPM": "HNPM", "ACST": "ACST", "WIT": "WIT", "OESZ": "Ošteuropäiši Summerzit", "HNNOMX": "HNNOMX", "JDT": "JDT", "ART": "ART", "CHAST": "CHAST", "MYT": "MYT", "NZDT": "NZDT", "SAST": "SAST", "LHDT": "LHDT", "HEPMX": "HEPMX", "WART": "WART", "VET": "VET", "HNPMX": "HNPMX"},
	}
}
