...
func New() locales.Translator {
	return &sr{
		...
		timezones:              map[string]string{"HEEG": "Источни Гренланд, летње време", "CAT": "Централно-афричко време", "WESZ": "Западноевропско летње време", "JST": "Јапанско стандардно време", "BOT": "Боливија време", "ACWST": "Аустралијско централно западно стандардно време", "WAST": "Западно-афричко летње време", "SRT": "Суринам време", "MDT": "Макао летње рачунање времена", "HEPM": "Сен Пјер и Микелон, летње време", "HADT": "Хавајско-алеутско летње време", "ARST": "Аргентина, летње време", "HECU": "Куба, летње време", "PDT": "Северноамеричко пацифичко летње време", "WAT": "Западно-афричко стандардно време", "GMT": "Средње време по Гриничу", "AKDT": "Аљаска, летње време", "CHADT": "Чатам, летње време", "NZDT": "Нови Зеланд, летње време", "LHDT": "Лорд Хов, летње време", "EST": "Северноамеричко источно стандардно време", "GYT": "Гвајана време", "WART": "Западна Аргентина, стандардно време", "WARST": "Западна Аргентина, летње време", "CHAST": "Чатам, стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "MESZ": "Средњеевропско летње време", "AEST": "Аустралијско источно стандардно време", "HEOG": "Западни Гренланд, летње време", "AKST": "Аљаска, стандардно време", "MST": "Макао стандардно време", "∅∅∅": "Азори, летње време", "MEZ": "Средњеевропско стандардно време", "AEDT": "Аустралијско источно летње време", "WIT": "Источно-индонезијско време", "OEZ": "Источноевропско стандардно време", "WITA": "Централно-индонезијско време", "HNEG": "Источни Гренланд, стандардно време", "CST": "Северноамеричко централно стандардно време", "GFT": "Француска Гвајана време", "COST": "Колумбија, летње време", "TMST": "Туркменистан, летње време", "NZST": "Нови Зеланд, стандардно време", "CDT": "Северноамеричко централно летње време", "ACWDT": "Аустралијско централно западно летње време", "HNOG": "Западни Гренланд, стандардно време", "AST": "Атлантско стандардно време", "HKT": "Хонг Конг, стандардно време", "AWST": "Аустралијско западно стандардно време", "ART": "Аргентина, стандардно време", "BT": "Бутан време", "SAST": "Јужно-афричко време", "ACDT": "Аустралијско централно летње време", "WIB": "Западно-индонезијско време", "CLT": "Чиле, стандардно време", "EAT": "Источно-афричко време", "VET": "Венецуела време", "ECT": "Еквадор време", "OESZ": "Источноевропско летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "HNT": "Њуфаундленд, стандардно време", "HAT": "Њуфаундленд, летње време", "ChST": "Чаморо време", "HAST": "Хавајско-алеутско стандардно време", "COT": "Колумбија, стандардно време", "HKST": "Хонг Конг, летње време", "JDT": "Јапанско летње време", "HENOMX": "Северозападни Мексико, летње време", "EDT": "Северноамеричко источно летње време", "HNCU": "Куба, стандардно време", "ACST": "Аустралијско централно стандардно време", "MYT": "Малезија време", "UYST": "Уругвај, летње време", "CLST": "Чиле, летње време", "SGT": "Сингапур, стандардно време", "AWDT": "Аустралијско западно летње време", "WEZ": "Западноевропско стандардно време", "IST": "Индијско стандардно време", "LHST": "Лорд Хов, стандардно време", "UYT": "Уругвај, стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "HEPMX": "Мексички Пацифик, летње време", "ADT": "Атлантско летње време", "TMT": "Туркменистан, стандардно време", "HNNOMX": "Северозападни Мексико, стандардно време"},
	}
}
