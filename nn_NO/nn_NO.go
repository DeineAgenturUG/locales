...
func New() locales.Translator {
	return &nn_NO{
		...
		timezones:              map[string]string{"BOT": "boliviansk tid", "AKST": "alaskisk normaltid", "EST": "normaltid for den nordamerikansk austkysten", "PST": "normaltid for den nordamerikanske stillehavskysten", "HAT": "sumartid for Newfoundland", "HADT": "sumartid for Hawaii og Aleutene", "∅∅∅": "peruansk sumartid", "HNOG": "vestgrønlandsk normaltid", "HKST": "hongkongkinesisk sumartid", "TMST": "turkmensk sumartid", "WITA": "sentralindonesisk tid", "CAT": "sentralafrikansk tid", "ACDT": "sentralaustralsk sommartid", "CLT": "chilensk normaltid", "GMT": "Greenwich middeltid", "WESZ": "vesteuropeisk sommartid", "WIB": "vestindonesisk tid", "HKT": "hongkongkinesisk normaltid", "WIT": "austindonesisk tid", "HECU": "kubansk sumartid", "PDT": "sumartid for den nordamerikanske stillehavskysten", "AEST": "austaustralsk standardtid", "AEDT": "austaustralsk sommartid", "WART": "vestargentinsk normaltid", "IST": "indisk tid", "MEZ": "sentraleuropeisk standardtid", "CLST": "chilensk sumartid", "MST": "MST", "TMT": "turkmensk normaltid", "HENOMX": "sumartid for nordvestlege Mexico", "ChST": "tidssone for Chamorro", "ACWST": "vest-sentralaustralsk standardtid", "COST": "kolombiansk sumartid", "ARST": "argentinsk sumartid", "CDT": "sumartid for sentrale Nord-Amerika", "EDT": "sumartid for den nordamerikansk austkysten", "UYT": "uruguayansk normaltid", "UYST": "uruguayansk sumartid", "HNNOMX": "normaltid for nordvestlege Mexico", "AKDT": "alaskisk sumartid", "LHST": "normaltid for Lord Howe-øya", "LHDT": "sumartid for Lord Howe-øya", "GFT": "tidssone for Fransk Guyana", "ACWDT": "vest-sentralaustralsk sommartid", "AWST": "vestaustralsk standardtid", "SGT": "singaporsk tid", "JST": "japansk normaltid", "HNT": "normaltid for Newfoundland", "HEPM": "sumartid for Saint-Pierre-et-Miquelon", "BT": "bhutansk tid", "HAST": "normaltid for Hawaii og Aleutene", "GYT": "guyansk tid", "CST": "normaltid for sentrale Nord-Amerika", "OESZ": "austeuropeisk sommartid", "ACST": "sentralaustralsk standardtid", "CHADT": "sumartid for Chatham", "HNPMX": "normaltid for den meksikanske stillehavskysten", "CHAST": "normaltid for Chatham", "WARST": "vestargentinsk sumartid", "NZDT": "nyzealandsk sumartid", "HNCU": "kubansk normaltid", "HNPM": "normaltid for Saint-Pierre-et-Miquelon", "ECT": "ecuadoriansk tid", "HEOG": "vestgrønlandsk sumartid", "MDT": "MDT", "AST": "normaltid for den nordamerikanske atlanterhavskysten", "EAT": "austafrikansk tid", "OEZ": "austeuropeisk standardtid", "SAST": "sørafrikansk tid", "HNEG": "austgrønlandsk normaltid", "COT": "kolombiansk normaltid", "SRT": "surinamsk tid", "ART": "argentinsk normaltid", "MYT": "malaysisk tid", "ADT": "sumartid for den nordamerikanske atlanterhavskysten", "VET": "venezuelansk tid", "MESZ": "sentraleuropeisk sommartid", "HEPMX": "sumartid for den meksikanske stillehavskysten", "WAT": "vestafrikansk standardtid", "JDT": "japansk sumartid", "NZST": "nyzealandsk normaltid", "HEEG": "austgrønlandsk sumartid", "WEZ": "vesteuropeisk standardtid", "WAST": "vestafrikansk sommartid", "AWDT": "vestaustralsk sommartid"},
	}
}
