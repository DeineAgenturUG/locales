...
func New() locales.Translator {
	return &ky{
		...
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"WIT": "Чыгыш Индонезия убактысы", "HECU": "Куба жайкы убактысы", "SAST": "Түштүк Африка убактысы", "ARST": "Аргентина жайкы убактысы", "CHAST": "Чатам кышкы убакыт", "CDT": "Түндүк Америка, борбордук жайкы убакыт", "WEZ": "Батыш Европа кышкы убакыты", "GYT": "Гвиана убактысы", "WITA": "Борбордук Индонезия убактысы", "AKST": "Аляска кышкы убактысы", "EST": "Түндүк Америка, чыгыш кышкы убактысы", "HADT": "Гавайи-Алеут жайкы убактысы", "GFT": "Француз Гвиана убактысы", "UYT": "Уругвай кышкы убактысы", "ACWST": "Австралия борбордук батыш кышкы убакыты", "WART": "Батыш Аргентина кышкы убактысы", "VET": "Венесуэла убактысы", "HENOMX": "Түндүк-чыгыш Мексика жайкы убактысы", "∅∅∅": "Бразилия жайкы убактысы", "HAST": "Гавайи-Алеут кышкы убактысы", "UYST": "Уругвай жайкы убактысы", "COT": "Колумбия кышкы убактысы", "HEOG": "Батыш Гренландия жайкы убактысы", "AWST": "Австралия батыш кышкы убакыты", "AKDT": "Аляска жайкы убактысы", "CHADT": "Чатам жайкы убактысы", "HNPM": "Сен Пьер жана Микелон кышкы убактысы", "CLT": "Чили кышкы убактысы", "CLST": "Чили жайкы убактысы", "COST": "Колумбия жайкы убактысы", "HNPMX": "Мексика, Тынч океан кышкы убактысы", "EAT": "Чыгыш Африка убактысы", "OESZ": "Чыгыш Европа жайкы убактысы", "NZDT": "Жаңы Зеландия жайкы убакыты", "HEPMX": "Мексика, Тынч океан жайкы убактысы", "HNT": "Нюфаундлэнд кышкы убактысы", "AST": "Атлантика кышкы убактысы", "HKT": "Гонконг кышкы убакыты", "EDT": "Түндүк Америка, чыгыш жайкы убактысы", "LHDT": "Лорд Хау жайкы убактысы", "WAST": "Батыш Африка жайкы убактысы", "HNEG": "Чыгыш Гренландия кышкы убактысы", "MYT": "Малайзия убактысы", "HKST": "Гонконг жайкы убактысы", "TMST": "Түркмөнстан жайкы убактысы", "HNNOMX": "Түндүк-чыгыш Мексика кышкы убактысы", "BOT": "Боливия убактысы", "MEZ": "Борбордук Европа кышкы убакыты", "WESZ": "Батыш Европа жайкы убактысы", "LHST": "Лорд Хау кышкы убакыты", "ChST": "Чаморро убактысы", "MDT": "MDT", "HEEG": "Чыгыш Гренландия жайкы убактысы", "CAT": "Борбордук Африка убактысы", "ACST": "Австралия борбордук кышкы убакыты", "CST": "Түндүк Америка, борбордук кышкы убактысы", "HNOG": "Батыш Гренландия кышкы убактысы", "SGT": "Сингапур убактысы", "TMT": "Түркмөнстан кышкы убакыты", "NZST": "Жаңы Зеландия кышкы убакыты", "ACDT": "Австралия борбордук жайкы убактысы", "IST": "Индия убактысы", "SRT": "Суринаме убактысы", "MST": "MST", "OEZ": "Чыгыш Европа кышкы убакыты", "PDT": "Түндүк Америка, Тынч океан жайкы убактысы", "WAT": "Батыш Африка кышкы убакыты", "AEST": "Австралия чыгыш кышкы убакыты", "ART": "Аргентина кышкы убактысы", "GMT": "Гринвич боюнча орточо убакыт", "ECT": "Экуадор убактысы", "JST": "Жапон кышкы убакыты", "PST": "Түндүк Америка, Тынч океан кышкы убактысы", "HAT": "Нюфаундлэнд жайкы убактысы", "BT": "Бутан убактысы", "ACWDT": "Австралия борбордук чыгыш жайкы убактысы", "ADT": "Атлантика жайкы убактысы", "AEDT": "Австралия чыгыш жайкы убактысы", "WARST": "Батыш Аргентина жайкы убактысы", "HNCU": "Куба кышкы убактысы", "MESZ": "Борбордук Европа жайкы убактысы", "HEPM": "Сен Пьер жана Микелон жайкы убактысы", "WIB": "Батыш Индонезия убактысы", "AWDT": "Австралия батыш жайкы убактысы", "JDT": "Жапон жайкы убактысы"},
	}
}
