...
func New() locales.Translator {
	return &nb_NO{
		...
		timezones:              map[string]string{"TMST": "turkmensk sommertid", "WART": "vestargentinsk normaltid", "VET": "venezuelansk tid", "HENOMX": "sommertid for nordvestlige Mexico", "∅∅∅": "sommertid for Brasilia", "SGT": "singaporsk tid", "ACWDT": "vest-sentralaustralsk sommertid", "CLT": "chilensk normaltid", "WAST": "vestafrikansk sommertid", "COT": "colombiansk normaltid", "AEDT": "østaustralsk sommertid", "NZDT": "newzealandsk sommertid", "PDT": "sommertid for den nordamerikanske Stillehavskysten", "WIB": "vestindonesisk tid", "MYT": "malaysisk tid", "CLST": "chilensk sommertid", "MST": "Macau, standardtid", "WIT": "østindonesisk tid", "HNPM": "normaltid for Saint-Pierre-et-Miquelon", "UYST": "uruguayansk sommertid", "WAT": "vestafrikansk normaltid", "AWDT": "vestaustralsk sommertid", "EAT": "østafrikansk tid", "JST": "japansk normaltid", "EDT": "sommertid for den nordamerikanske østkysten", "LHST": "normaltid for Lord Howe-øya", "MDT": "Macau, sommertid", "AWST": "vestaustralsk normaltid", "WARST": "vestargentinsk sommertid", "HNEG": "østgrønlandsk normaltid", "COST": "colombiansk sommertid", "OESZ": "østeuropeisk sommertid", "HECU": "cubansk sommertid", "AEST": "østaustralsk normaltid", "HNCU": "cubansk normaltid", "HEPMX": "sommertid for den meksikanske Stillehavskysten", "HEOG": "vestgrønlandsk sommertid", "BT": "bhutansk tid", "HEPM": "sommertid for Saint-Pierre-et-Miquelon", "GYT": "guyansk tid", "OEZ": "østeuropeisk normaltid", "WITA": "sentralindonesisk tid", "AKDT": "alaskisk sommertid", "ACDT": "sentralaustralsk sommertid", "UYT": "uruguayansk normaltid", "ACWST": "vest-sentralaustralsk normaltid", "AST": "normaltid for den nordamerikanske atlanterhavskysten", "ADT": "sommertid for den nordamerikanske atlanterhavskysten", "HKT": "normaltid for Hongkong", "HAT": "sommertid for Newfoundland", "CDT": "sommertid for det sentrale Nord-Amerika", "HAST": "normaltid for Hawaii og Aleutene", "ChST": "tidssone for Chamorro", "GMT": "Greenwich middeltid", "HNOG": "vestgrønlandsk normaltid", "TMT": "turkmensk normaltid", "EST": "normaltid for den nordamerikanske østkysten", "LHDT": "sommertid for Lord Howe-øya", "AKST": "alaskisk normaltid", "CST": "normaltid for det sentrale Nord-Amerika", "SAST": "sørafrikansk tid", "HEEG": "østgrønlandsk sommertid", "CHAST": "normaltid for Chatham", "JDT": "japansk sommertid", "HNNOMX": "normaltid for nordvestlige Mexico", "PST": "normaltid for den nordamerikanske Stillehavskysten", "BOT": "boliviansk tid", "MEZ": "sentraleuropeisk normaltid", "CHADT": "sommertid for Chatham", "IST": "indisk tid", "WEZ": "vesteuropeisk normaltid", "WESZ": "vesteuropeisk sommertid", "SRT": "surinamsk tid", "NZST": "newzealandsk normaltid", "ARST": "argentinsk sommertid", "CAT": "sentralafrikansk tid", "ART": "argentinsk normaltid", "ACST": "sentralaustralsk normaltid", "HADT": "sommertid for Hawaii og Aleutene", "GFT": "tidssone for Fransk Guyana", "HNPMX": "normaltid for den meksikanske Stillehavskysten", "ECT": "ecuadoriansk tid", "HNT": "normaltid for Newfoundland", "MESZ": "sentraleuropeisk sommertid", "HKST": "sommertid for Hongkong"},
	}
}
