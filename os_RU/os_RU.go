...
func New() locales.Translator {
	return &os_RU{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"AWDT": "AWDT", "JDT": "JDT", "HNT": "HNT", "ACDT": "ACDT", "WAST": "WAST", "GMT": "Гринвичы рӕстӕмбис рӕстӕг", "ADT": "ADT", "HKST": "HKST", "CHADT": "CHADT", "HAST": "HAST", "CST": "CST", "IST": "IST", "LHST": "LHST", "HNPMX": "HNPMX", "EAT": "EAT", "BOT": "BOT", "MESZ": "Астӕуккаг Европӕйаг сӕрдыгон рӕстӕг", "HAT": "HAT", "WAT": "WAT", "HNNOMX": "HNNOMX", "NZST": "NZST", "NZDT": "NZDT", "HNOG": "HNOG", "HNCU": "HNCU", "PDT": "PDT", "EST": "EST", "OEZ": "Скӕсӕн Европӕйаг стандартон рӕстӕг", "∅∅∅": "∅∅∅", "AKST": "AKST", "MYT": "MYT", "HEOG": "HEOG", "AWST": "AWST", "WITA": "WITA", "WIB": "WIB", "CLT": "CLT", "COST": "COST", "GYT": "GYT", "SRT": "SRT", "LHDT": "LHDT", "HKT": "HKT", "SGT": "SGT", "AKDT": "AKDT", "ACWST": "ACWST", "ACWDT": "ACWDT", "COT": "COT", "MDT": "MDT", "WART": "WART", "CAT": "CAT", "ARST": "ARST", "ACST": "ACST", "EDT": "EDT", "GFT": "GFT", "HEPMX": "HEPMX", "TMT": "TMT", "WARST": "WARST", "HEEG": "HEEG", "ECT": "ECT", "AEST": "AEST", "VET": "VET", "CHAST": "CHAST", "MST": "MST", "WIT": "WIT", "WESZ": "Ныгъуылӕн Европӕйаг сӕрдыгон рӕстӕг", "HADT": "HADT", "OESZ": "Скӕсӕн Европӕйаг сӕрдыгон рӕстӕг", "MEZ": "Астӕуккаг Европӕйаг стандартон рӕстӕг", "WEZ": "Ныгъуылӕн Европӕйаг стандартон рӕстӕг", "CLST": "CLST", "AEDT": "AEDT", "HECU": "HECU", "BT": "BT", "UYT": "UYT", "SAST": "SAST", "HNPM": "HNPM", "CDT": "CDT", "UYST": "UYST", "AST": "AST", "HENOMX": "HENOMX", "ART": "ART", "HEPM": "HEPM", "ChST": "ChST", "JST": "JST", "TMST": "TMST", "PST": "PST", "HNEG": "HNEG"},
	}
}
