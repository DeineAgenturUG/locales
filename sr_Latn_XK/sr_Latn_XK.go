...
func New() locales.Translator {
	return &sr_Latn_XK{
		...
		timezones:              map[string]string{"HEEG": "Источни Гренланд, летње време", "CHADT": "Чатам, летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "JST": "Јапанско стандардно време", "HNNOMX": "Северозападни Мексико, стандардно време", "CHAST": "Чатам, стандардно време", "IST": "Индијско стандардно време", "CST": "Северноамеричко централно стандардно време", "WIB": "Западно-индонезијско време", "MYT": "Малезија време", "HADT": "Хавајско-алеутско летње време", "WIT": "Источно-индонезијско време", "HNCU": "Куба, стандардно време", "AST": "Атлантско стандардно време", "AEST": "Аустралијско источно стандардно време", "OESZ": "Источноевропско летње време", "ACWST": "Аустралијско централно западно стандардно време", "HNOG": "Западни Гренланд, стандардно време", "TMT": "Туркменистан, стандардно време", "BOT": "Боливија време", "ART": "Аргентина, стандардно време", "WEZ": "Западноевропско стандардно време", "MDT": "Макао летње рачунање времена", "ECT": "Еквадор време", "SGT": "Сингапур, стандардно време", "NZDT": "Нови Зеланд, летње време", "PST": "Северноамеричко пацифичко стандардно време", "MESZ": "Средњеевропско летње време", "ARST": "Аргентина, летње време", "ACST": "Аустралијско централно стандардно време", "LHDT": "Лорд Хов, летње време", "WAT": "Западно-афричко стандардно време", "JDT": "Јапанско летње време", "HENOMX": "Северозападни Мексико, летње време", "COST": "Колумбија, летње време", "ADT": "Атлантско летње време", "BT": "Бутан време", "WAST": "Западно-афричко летње време", "HEPMX": "Мексички Пацифик, летње време", "MST": "Макао стандардно време", "NZST": "Нови Зеланд, стандардно време", "CAT": "Централно-афричко време", "HAT": "Њуфаундленд, летње време", "EDT": "Северноамеричко источно летње време", "ACWDT": "Аустралијско централно западно летње време", "COT": "Колумбија, стандардно време", "SRT": "Суринам време", "HKT": "Хонг Конг, стандардно време", "WITA": "Централно-индонезијско време", "HNEG": "Источни Гренланд, стандардно време", "ACDT": "Аустралијско централно летње време", "AEDT": "Аустралијско источно летње време", "TMST": "Туркменистан, летње време", "PDT": "Северноамеричко пацифичко летње време", "WART": "Западна Аргентина, стандардно време", "SAST": "Јужно-афричко време", "MEZ": "Средњеевропско стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "AWDT": "Аустралијско западно летње време", "EAT": "Источно-афричко време", "CDT": "Северноамеричко централно летње време", "LHST": "Лорд Хов, стандардно време", "GMT": "Средње време по Гриничу", "AKST": "Аљаска, стандардно време", "AKDT": "Аљаска, летње време", "CLST": "Чиле, летње време", "GYT": "Гвајана време", "HECU": "Куба, летње време", "UYST": "Уругвај, летње време", "HEPM": "Сен Пјер и Микелон, летње време", "HAST": "Хавајско-алеутско стандардно време", "ChST": "Чаморо време", "GFT": "Француска Гвајана време", "AWST": "Аустралијско западно стандардно време", "HNT": "Њуфаундленд, стандардно време", "OEZ": "Источноевропско стандардно време", "EST": "Северноамеричко источно стандардно време", "CLT": "Чиле, стандардно време", "HEOG": "Западни Гренланд, летње време", "∅∅∅": "Азори, летње време", "VET": "Венецуела време", "WESZ": "Западноевропско летње време", "UYT": "Уругвај, стандардно време", "HKST": "Хонг Конг, летње време", "WARST": "Западна Аргентина, летње време"},
	}
}
