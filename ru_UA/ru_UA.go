...
func New() locales.Translator {
	return &ru_UA{
		...
		timezones:              map[string]string{"OEZ": "Восточная Европа, стандартное время", "WITA": "Центральная Индонезия", "AKDT": "Аляска, летнее время", "CAT": "Центральная Африка", "HEPMX": "Тихоокеанское мексиканское летнее время", "GYT": "Гайана", "HEOG": "Западная Гренландия, летнее время", "∅∅∅": "Азорские о-ва, летнее время", "AKST": "Аляска, стандартное время", "MEZ": "Центральная Европа, стандартное время", "EST": "Восточная Америка, стандартное время", "MST": "Макао, стандартное время", "EAT": "Восточная Африка", "PST": "Тихоокеанское стандартное время", "ART": "Аргентина, стандартное время", "HNPM": "Сен-Пьер и Микелон, стандартное время", "WIB": "Западная Индонезия", "TMST": "Туркменистан, летнее время", "CHAST": "Чатем, стандартное время", "CST": "Центральная Америка, стандартное время", "GFT": "Французская Гвиана", "WAT": "Западная Африка, стандартное время", "AEDT": "Восточная Австралия, летнее время", "HKT": "Гонконг, стандартное время", "BOT": "Боливия", "WEZ": "Западная Европа, стандартное время", "HNPMX": "Тихоокеанское мексиканское стандартное время", "SRT": "Суринам", "AWST": "Западная Австралия, стандартное время", "WIT": "Восточная Индонезия", "LHDT": "Лорд-Хау, летнее время", "UYT": "Уругвай, стандартное время", "ACWDT": "Центральная Австралия, западное летнее время", "JST": "Япония, стандартное время", "CDT": "Центральная Америка, летнее время", "GMT": "Среднее время по Гринвичу", "HNEG": "Восточная Гренландия, стандарное время", "ECT": "Эквадор", "HEEG": "Восточная Гренландия, летнее время", "HEPM": "Сен-Пьер и Микелон, летнее время", "ChST": "Чаморро", "CLST": "Чили, летнее время", "MDT": "Макао, летнее время", "TMT": "Туркменистан, стандартное время", "HENOMX": "Северо-западное мексиканское летнее время", "LHST": "Лорд-Хау, стандартное время", "HADT": "Гавайско-алеутское летнее время", "COT": "Колумбия, стандартное время", "ADT": "Атлантическое летнее время", "WARST": "Западная Аргентина, летнее время", "EDT": "Восточная Америка, летнее время", "UYST": "Уругвай, летнее время", "AWDT": "Западная Австралия, летнее время", "JDT": "Япония, летнее время", "NZST": "Новая Зеландия, стандартное время", "HECU": "Куба, летнее время", "BT": "Бутан", "CHADT": "Чатем, летнее время", "COST": "Колумбия, летнее время", "AST": "Атлантическое стандартное время", "HKST": "Гонконг, летнее время", "HNNOMX": "Северо-западное мексиканское стандартное время", "MESZ": "Центральная Европа, летнее время", "HAST": "Гавайско-алеутское стандартное время", "HNOG": "Западная Гренландия, стандартное время", "SGT": "Сингапур", "WART": "Западная Аргентина, стандартное время", "VET": "Венесуэла", "WAST": "Западная Африка, летнее время", "OESZ": "Восточная Европа, летнее время", "IST": "Индия", "MYT": "Малайзия", "ACWST": "Центральная Австралия, западное стандартное время", "CLT": "Чили, стандартное время", "AEST": "Восточная Австралия, стандартное время", "ACST": "Центральная Австралия, стандартное время", "NZDT": "Новая Зеландия, летнее время", "HNCU": "Куба, стандартное время", "PDT": "Тихоокеанское летнее время", "SAST": "Южная Африка", "HNT": "Ньюфаундленд, стандартное время", "HAT": "Ньюфаундленд, летнее время", "ARST": "Аргентина, летнее время", "ACDT": "Центральная Австралия, летнее время", "WESZ": "Западная Европа, летнее время"},
	}
}
