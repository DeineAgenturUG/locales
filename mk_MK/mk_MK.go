...
func New() locales.Translator {
	return &mk_MK{
		...
		timezones:              map[string]string{"HECU": "Летно сметање на времето во Куба", "HEEG": "Летно сметање на времето во Источен Гренланд", "MEZ": "Средноевропско стандардно време", "WIB": "Време во Западна Индонезија", "HAST": "Стандардно време во Хаваи - Алеутски острови", "WIT": "Време во Источна Индонезија", "OEZ": "Источноевропско стандардно време", "BT": "Време во Бутан", "IST": "Време во Индија", "LHDT": "Летно сметање на времето во Лорд Хау", "WARST": "Летно сметање на времето во западна Аргентина", "AEDT": "Летно сметање на времето во Источна Австралија", "SGT": "Време во Сингапур", "NZDT": "Летно сметање на времето во Нов Зеланд", "CHAST": "Стандардно време во Чатам", "CDT": "Централно летно сметање на времето", "LHST": "Стандардно време во Лорд Хау", "MYT": "Време во Малезија", "AST": "Атлантско стандардно време", "SAST": "Време во Јужноафриканска Република", "HEPM": "Летно сметање на времето на Сент Пјер и Микелан", "WART": "Стандардно време во западна Аргентина", "HENOMX": "Летно сметање на времето во северозападно Мексико", "ARST": "Летно сметање на времето во Аргентина", "COST": "Летно сметање на времето во Колумбија", "GYT": "Време во Гвајана", "MDT": "MDT", "JST": "Стандардно време во Јапонија", "∅∅∅": "Летно сметање на времето во Бразилија", "HADT": "Летно сметање на времето во Хаваи - Алеутски острови", "COT": "Стандардно време во Колумбија", "HKT": "Стандардно време во Хонг Конг", "NZST": "Стандардно време во Нов Зеланд", "PDT": "Пацифичко летно сметање на времето", "CAT": "Средноафриканско време", "GFT": "Време во Француска Гвајана", "SRT": "Време во Суринам", "MST": "MST", "OESZ": "Источноевропско летно време", "AEST": "Стандардно време во Источна Австралија", "AWDT": "Летно сметање на времето во Западна Австралија", "HNEG": "Стандардно време во Источен Гренланд", "ART": "Стандардно време во Аргентина", "WEZ": "Западноевропско стандардно време", "WESZ": "Западноевропско летно време", "WAT": "Западноафриканско стандардно време", "ACWST": "Стандардно време во Централна и Западна Австралија", "AKST": "Стандардно време во Алјаска", "CLST": "Летно сметање на времето во Чиле", "GMT": "Средно време по Гринич", "PST": "Пацифичко стандардно време", "WITA": "Време во Централна Индонезија", "JDT": "Летно сметање на времето во Јапонија", "UYST": "Летно сметање на времето во Уругвај", "ECT": "Време во Еквадор", "HAT": "Летно сметање на времето на Њуфаундленд", "HNPMX": "Стандардно пацифичко време во Мексико", "ADT": "Атлантско летно сметање на времето", "HNOG": "Стандардно време во Западен Гренланд", "VET": "Време во Венецуела", "HNT": "Стандардно време на Њуфаундленд", "CST": "Централно стандардно време во Северна Америка", "WAST": "Западноафриканско летно сметање на времето", "ACWDT": "Летно сметање на времето во Централна и Западна Австралија", "CLT": "Стандардно време во Чиле", "HKST": "Летно време во Хонг Конг", "TMT": "Стандардно време во Туркменистан", "TMST": "Летно време во Туркменистан", "EAT": "Источноафриканско време", "MESZ": "Средноевропско летно време", "HNPM": "Стандардно време на Сент Пјер и Микелан", "EST": "Источно стандардно време", "EDT": "Источно летно сметање на времето", "UYT": "Стандардно време во Уругвај", "AWST": "Стандардно време во Западна Австралија", "BOT": "Време во Боливија", "AKDT": "Летно сметање на времето во Алјаска", "ACST": "Стандардно време во Централна Австралија", "CHADT": "Летно сметање на времето во Чатам", "HEPMX": "Летно пацифичко време во Мексико", "HEOG": "Летно сметање на времето во Западен Гренланд", "ACDT": "Летно сметање на времето во Централна Австралија", "ChST": "Време во Чаморо", "HNCU": "Стандардно време во Куба", "HNNOMX": "Стандардно време во северозападно Мексико"},
	}
}
