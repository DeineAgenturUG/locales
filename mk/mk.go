...
func New() locales.Translator {
	return &mk{
		...
		timezones:              map[string]string{"UYT": "Стандардно време во Уругвај", "GYT": "Време во Гвајана", "WARST": "Летно сметање на времето во западна Аргентина", "PDT": "Пацифичко летно сметање на времето", "CHAST": "Стандардно време во Чатам", "HNPM": "Стандардно време на Сент Пјер и Микелан", "WESZ": "Западноевропско летно време", "LHST": "Стандардно време во Лорд Хау", "GFT": "Време во Француска Гвајана", "GMT": "Средно време по Гринич", "AST": "Атлантско стандардно време", "HNCU": "Стандардно време во Куба", "HENOMX": "Летно сметање на времето во северозападно Мексико", "HNOG": "Стандардно време во Западен Гренланд", "SGT": "Време во Сингапур", "TMST": "Летно време во Туркменистан", "MESZ": "Средноевропско летно време", "EST": "Источно стандардно време", "ChST": "Време во Чаморо", "HAST": "Стандардно време во Хаваи - Алеутски острови", "UYST": "Летно сметање на времето во Уругвај", "MST": "MST", "JST": "Стандардно време во Јапонија", "AEDT": "Летно сметање на времето во Источна Австралија", "JDT": "Летно сметање на времето во Јапонија", "EAT": "Источноафриканско време", "ARST": "Летно сметање на времето во Аргентина", "HKT": "Стандардно време во Хонг Конг", "VET": "Време во Венецуела", "NZDT": "Летно сметање на времето во Нов Зеланд", "HNEG": "Стандардно време во Источен Гренланд", "ACWST": "Стандардно време во Централна и Западна Австралија", "CLST": "Летно сметање на времето во Чиле", "WAST": "Западноафриканско летно сметање на времето", "HKST": "Летно време во Хонг Конг", "AWDT": "Летно сметање на времето во Западна Австралија", "CAT": "Средноафриканско време", "IST": "Време во Индија", "WAT": "Западноафриканско стандардно време", "HNNOMX": "Стандардно време во северозападно Мексико", "HEEG": "Летно сметање на времето во Источен Гренланд", "COST": "Летно сметање на времето во Колумбија", "MDT": "MDT", "OESZ": "Источноевропско летно време", "WITA": "Време во Централна Индонезија", "HEPM": "Летно сметање на времето на Сент Пјер и Микелан", "WEZ": "Западноевропско стандардно време", "HADT": "Летно сметање на времето во Хаваи - Алеутски острови", "ACWDT": "Летно сметање на времето во Централна и Западна Австралија", "HNPMX": "Стандардно пацифичко време во Мексико", "ECT": "Време во Еквадор", "WART": "Стандардно време во западна Аргентина", "MYT": "Време во Малезија", "COT": "Стандардно време во Колумбија", "TMT": "Стандардно време во Туркменистан", "MEZ": "Средноевропско стандардно време", "ACDT": "Летно сметање на времето во Централна Австралија", "LHDT": "Летно сметање на времето во Лорд Хау", "AEST": "Стандардно време во Источна Австралија", "WIT": "Време во Источна Индонезија", "OEZ": "Источноевропско стандардно време", "HAT": "Летно сметање на времето на Њуфаундленд", "AKST": "Стандардно време во Алјаска", "CST": "Централно стандардно време во Северна Америка", "HEOG": "Летно сметање на времето во Западен Гренланд", "SAST": "Време во Јужноафриканска Република", "ART": "Стандардно време во Аргентина", "∅∅∅": "Летно сметање на времето во Бразилија", "BOT": "Време во Боливија", "ACST": "Стандардно време во Централна Австралија", "HECU": "Летно сметање на времето во Куба", "NZST": "Стандардно време во Нов Зеланд", "PST": "Пацифичко стандардно време", "CHADT": "Летно сметање на времето во Чатам", "CDT": "Централно летно сметање на времето", "WIB": "Време во Западна Индонезија", "AKDT": "Летно сметање на времето во Алјаска", "EDT": "Источно летно сметање на времето", "CLT": "Стандардно време во Чиле", "HEPMX": "Летно пацифичко време во Мексико", "SRT": "Време во Суринам", "ADT": "Атлантско летно сметање на времето", "AWST": "Стандардно време во Западна Австралија", "HNT": "Стандардно време на Њуфаундленд", "BT": "Време во Бутан"},
	}
}
