...
func New() locales.Translator {
	return &ru_BY{
		...
		timezones:              map[string]string{"WAST": "Западная Африка, летнее время", "OEZ": "Восточная Европа, стандартное время", "IST": "Индия", "LHST": "Лорд-Хау, стандартное время", "HEPMX": "Тихоокеанское мексиканское летнее время", "WARST": "Западная Аргентина, летнее время", "MYT": "Малайзия", "MDT": "Макао, летнее время", "WITA": "Центральная Индонезия", "CST": "Центральная Америка, стандартное время", "EDT": "Восточная Америка, летнее время", "HNOG": "Западная Гренландия, стандартное время", "AKST": "Аляска, стандартное время", "CHADT": "Чатем, летнее время", "WEZ": "Западная Европа, стандартное время", "HNNOMX": "Северо-западное мексиканское стандартное время", "CDT": "Центральная Америка, летнее время", "WESZ": "Западная Европа, летнее время", "WIB": "Западная Индонезия", "ChST": "Чаморро", "CLST": "Чили, летнее время", "AEDT": "Восточная Австралия, летнее время", "HKT": "Гонконг, стандартное время", "MST": "Макао, стандартное время", "PDT": "Тихоокеанское летнее время", "CAT": "Центральная Африка", "AWDT": "Западная Австралия, летнее время", "TMST": "Туркменистан, летнее время", "WART": "Западная Аргентина, стандартное время", "VET": "Венесуэла", "HAT": "Ньюфаундленд, летнее время", "AKDT": "Аляска, летнее время", "COT": "Колумбия, стандартное время", "AST": "Атлантическое стандартное время", "HKST": "Гонконг, летнее время", "HECU": "Куба, летнее время", "HAST": "Гавайско-алеутское стандартное время", "ADT": "Атлантическое летнее время", "CHAST": "Чатем, стандартное время", "LHDT": "Лорд-Хау, летнее время", "JDT": "Япония, летнее время", "TMT": "Туркменистан, стандартное время", "HNCU": "Куба, стандартное время", "ACST": "Центральная Австралия, стандартное время", "ACWST": "Центральная Австралия, западное стандартное время", "ACWDT": "Центральная Австралия, западное летнее время", "CLT": "Чили, стандартное время", "AEST": "Восточная Австралия, стандартное время", "HNPM": "Сен-Пьер и Микелон, стандартное время", "SGT": "Сингапур", "NZST": "Новая Зеландия, стандартное время", "PST": "Тихоокеанское стандартное время", "HNT": "Ньюфаундленд, стандартное время", "GFT": "Французская Гвиана", "∅∅∅": "Акри летнее время", "SRT": "Суринам", "HEOG": "Западная Гренландия, летнее время", "UYST": "Уругвай, летнее время", "WIT": "Восточная Индонезия", "MESZ": "Центральная Европа, летнее время", "BT": "Бутан", "HNPMX": "Тихоокеанское мексиканское стандартное время", "AWST": "Западная Австралия, стандартное время", "SAST": "Южная Африка", "BOT": "Боливия", "HENOMX": "Северо-западное мексиканское летнее время", "HEEG": "Восточная Гренландия, летнее время", "HEPM": "Сен-Пьер и Микелон, летнее время", "UYT": "Уругвай, стандартное время", "COST": "Колумбия, летнее время", "ECT": "Эквадор", "NZDT": "Новая Зеландия, летнее время", "OESZ": "Восточная Европа, летнее время", "ART": "Аргентина, стандартное время", "ACDT": "Центральная Австралия, летнее время", "EST": "Восточная Америка, стандартное время", "HADT": "Гавайско-алеутское летнее время", "WAT": "Западная Африка, стандартное время", "GMT": "Среднее время по Гринвичу", "GYT": "Гайана", "ARST": "Аргентина, летнее время", "EAT": "Восточная Африка", "JST": "Япония, стандартное время", "HNEG": "Восточная Гренландия, стандарное время", "MEZ": "Центральная Европа, стандартное время"},
	}
}
