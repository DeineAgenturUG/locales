...
func New() locales.Translator {
	return &ru_KG{
		...
		timezones:              map[string]string{"HKT": "Гонконг, стандартное время", "JDT": "Япония, летнее время", "BOT": "Боливия", "BT": "Бутан", "LHDT": "Лорд-Хау, летнее время", "CLST": "Чили, летнее время", "SAST": "Южная Африка", "ACST": "Центральная Австралия, стандартное время", "HAST": "Гавайско-алеутское стандартное время", "ChST": "Чаморро", "HNPMX": "Тихоокеанское мексиканское стандартное время", "AWST": "Западная Австралия, стандартное время", "IST": "Индия", "CST": "Центральная Америка, стандартное время", "WIB": "Западная Индонезия", "EDT": "Восточная Америка, летнее время", "MYT": "Малайзия", "MDT": "Летнее горное время (Северная Америка)", "OEZ": "Восточная Европа, стандартное время", "CHAST": "Чатем, стандартное время", "WESZ": "Западная Европа, летнее время", "GYT": "Гайана", "HNCU": "Куба, стандартное время", "HEPM": "Сен-Пьер и Микелон, летнее время", "HADT": "Гавайско-алеутское летнее время", "COT": "Колумбия, стандартное время", "ADT": "Атлантическое летнее время", "AEST": "Восточная Австралия, стандартное время", "∅∅∅": "Азорские о-ва, летнее время", "HNT": "Ньюфаундленд, стандартное время", "ART": "Аргентина, стандартное время", "UYT": "Уругвай, стандартное время", "ACWST": "Центральная Австралия, западное стандартное время", "HNOG": "Западная Гренландия, стандартное время", "TMT": "Туркменистан, стандартное время", "WITA": "Центральная Индонезия", "AKDT": "Аляска, летнее время", "AST": "Атлантическое стандартное время", "GFT": "Французская Гвиана", "HECU": "Куба, летнее время", "PDT": "Тихоокеанское летнее время", "EST": "Восточная Америка, стандартное время", "CLT": "Чили, стандартное время", "COST": "Колумбия, летнее время", "AEDT": "Восточная Австралия, летнее время", "MST": "Стандартное горное время (Северная Америка)", "VET": "Венесуэла", "HEEG": "Восточная Гренландия, летнее время", "AKST": "Аляска, стандартное время", "HEPMX": "Тихоокеанское мексиканское летнее время", "ACWDT": "Центральная Австралия, западное летнее время", "MESZ": "Центральная Европа, летнее время", "SRT": "Суринам", "ECT": "Эквадор", "UYST": "Уругвай, летнее время", "AWDT": "Западная Австралия, летнее время", "OESZ": "Восточная Европа, летнее время", "PST": "Тихоокеанское стандартное время", "MEZ": "Центральная Европа, стандартное время", "HNPM": "Сен-Пьер и Микелон, стандартное время", "ACDT": "Центральная Австралия, летнее время", "WEZ": "Западная Европа, стандартное время", "WAT": "Западная Африка, стандартное время", "EAT": "Восточная Африка", "NZDT": "Новая Зеландия, летнее время", "HKST": "Гонконг, летнее время", "HNNOMX": "Северо-западное мексиканское стандартное время", "HENOMX": "Северо-западное мексиканское летнее время", "NZST": "Новая Зеландия, стандартное время", "HNEG": "Восточная Гренландия, стандарное время", "CDT": "Центральная Америка, летнее время", "WART": "Западная Аргентина, стандартное время", "ARST": "Аргентина, летнее время", "CAT": "Центральная Африка", "GMT": "Среднее время по Гринвичу", "CHADT": "Чатем, летнее время", "HEOG": "Западная Гренландия, летнее время", "SGT": "Сингапур", "WIT": "Восточная Индонезия", "TMST": "Туркменистан, летнее время", "JST": "Япония, стандартное время", "WARST": "Западная Аргентина, летнее время", "HAT": "Ньюфаундленд, летнее время", "LHST": "Лорд-Хау, стандартное время", "WAST": "Западная Африка, летнее время"},
	}
}
