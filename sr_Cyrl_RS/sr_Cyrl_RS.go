...
func New() locales.Translator {
	return &sr_Cyrl_RS{
		...
		timezones:              map[string]string{"LHST": "Лорд Хов, стандардно време", "ECT": "Еквадор време", "BOT": "Боливија време", "WEZ": "Западноевропско стандардно време", "VET": "Венецуела време", "HNNOMX": "Северозападни Мексико, стандардно време", "ACWDT": "Аустралијско централно западно летње време", "HNPMX": "Мексички Пацифик, стандардно време", "GMT": "Средње време по Гриничу", "AWDT": "Аустралијско западно летње време", "EAT": "Источно-афричко време", "WART": "Западна Аргентина, стандардно време", "NZDT": "Нови Зеланд, летње време", "HECU": "Куба, летње време", "GYT": "Гвајана време", "SRT": "Суринам време", "AST": "Атлантско стандардно време", "HEEG": "Источни Гренланд, летње време", "CHADT": "Чатам, летње време", "CDT": "Северноамеричко централно летње време", "ACST": "Аустралијско централно стандардно време", "MST": "Макао стандардно време", "HKT": "Хонг Конг, стандардно време", "ARST": "Аргентина, летње време", "JDT": "Јапанско летње време", "∅∅∅": "Азори, летње време", "PDT": "Северноамеричко пацифичко летње време", "IST": "Индијско стандардно време", "WAT": "Западно-афричко стандардно време", "AEST": "Аустралијско источно стандардно време", "AWST": "Аустралијско западно стандардно време", "MEZ": "Средњеевропско стандардно време", "ART": "Аргентина, стандардно време", "BT": "Бутан време", "OESZ": "Источноевропско летње време", "SAST": "Јужно-афричко време", "HNEG": "Источни Гренланд, стандардно време", "HAST": "Хавајско-алеутско стандардно време", "COT": "Колумбија, стандардно време", "HENOMX": "Северозападни Мексико, летње време", "EDT": "Северноамеричко источно летње време", "NZST": "Нови Зеланд, стандардно време", "AKDT": "Аљаска, летње време", "COST": "Колумбија, летње време", "HEOG": "Западни Гренланд, летње време", "WIT": "Источно-индонезијско време", "HNT": "Њуфаундленд, стандардно време", "HAT": "Њуфаундленд, летње време", "AKST": "Аљаска, стандардно време", "EST": "Северноамеричко источно стандардно време", "ChST": "Чаморо време", "UYT": "Уругвај, стандардно време", "HEPMX": "Мексички Пацифик, летње време", "OEZ": "Источноевропско стандардно време", "JST": "Јапанско стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "CST": "Северноамеричко централно стандардно време", "GFT": "Француска Гвајана време", "UYST": "Уругвај, летње време", "ACWST": "Аустралијско централно западно стандардно време", "CLST": "Чиле, летње време", "LHDT": "Лорд Хов, летње време", "MYT": "Малезија време", "ADT": "Атлантско летње време", "HKST": "Хонг Конг, летње време", "WITA": "Централно-индонезијско време", "HNCU": "Куба, стандардно време", "WESZ": "Западноевропско летње време", "CHAST": "Чатам, стандардно време", "SGT": "Сингапур, стандардно време", "MESZ": "Средњеевропско летње време", "CAT": "Централно-афричко време", "HADT": "Хавајско-алеутско летње време", "CLT": "Чиле, стандардно време", "AEDT": "Аустралијско источно летње време", "WIB": "Западно-индонезијско време", "TMT": "Туркменистан, стандардно време", "TMST": "Туркменистан, летње време", "WARST": "Западна Аргентина, летње време", "ACDT": "Аустралијско централно летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "WAST": "Западно-афричко летње време", "MDT": "Макао летње рачунање времена", "HNOG": "Западни Гренланд, стандардно време", "HEPM": "Сен Пјер и Микелон, летње време"},
	}
}
