...
func New() locales.Translator {
	return &he_IL{
		...
		timezones:              map[string]string{"SGT": "שעון סינגפור", "PDT": "שעון מערב ארה״ב (קיץ)", "MESZ": "שעון מרכז אירופה (קיץ)", "CAT": "שעון מרכז אפריקה", "HAST": "שעון האיים האלאוטיים הוואי (חורף)", "WEZ": "שעון מערב אירופה (חורף)", "ChST": "שעון צ׳אמורו", "GMT": "שעון גריניץ׳\u200f", "AST": "שעון האוקיינוס האטלנטי (חורף)", "AWST": "שעון מערב אוסטרליה (חורף)", "ACST": "שעון מרכז אוסטרליה (חורף)", "HNPM": "שעון סנט פייר ומיקלון (חורף)", "HEPM": "שעון סנט פייר ומיקלון (קיץ)", "MDT": "שעון אזור ההרים בארה״ב (קיץ)", "WIT": "שעון מזרח אינדונזיה", "JDT": "שעון יפן (קיץ)", "LHDT": "שעון אי הלורד האו (קיץ)", "CLST": "שעון צ׳ילה (קיץ)", "WESZ": "שעון מערב אירופה (קיץ)", "NZST": "שעון ניו זילנד (חורף)", "HECU": "שעון קובה (קיץ)", "HNEG": "שעון מזרח גרינלנד (חורף)", "MEZ": "שעון מרכז אירופה (חורף)", "ARST": "שעון ארגנטינה (קיץ)", "ART": "שעון ארגנטינה (חורף)", "HADT": "שעון האיים האלאוטיים הוואי (קיץ)", "WAT": "שעון מערב אפריקה (חורף)", "ADT": "שעון האוקיינוס האטלנטי (קיץ)", "WARST": "שעון מערב ארגנטינה (קיץ)", "HENOMX": "שעון צפון-מערב מקסיקו (קיץ)", "HNT": "שעון ניופאונדלנד (חורף)", "AKST": "שעון אלסקה (חורף)", "VET": "שעון ונצואלה", "CDT": "שעון מרכז ארה״ב (קיץ)", "WIB": "שעון מערב אינדונזיה", "ECT": "שעון אקוודור", "AKDT": "שעון אלסקה (קיץ)", "BT": "שעון בהוטן", "IST": "שעון הודו", "MYT": "שעון מלזיה", "MST": "שעון אזור ההרים בארה״ב (חורף)", "ACDT": "שעון מרכז אוסטרליה (קיץ)", "EST": "שעון החוף המזרחי (חורף)", "HKST": "שעון הונג קונג (קיץ)", "WITA": "שעון מרכז אינדונזיה", "HEEG": "שעון מזרח גרינלנד (קיץ)", "GYT": "שעון גיאנה", "LHST": "שעון אי הלורד האו (חורף)", "WAST": "שעון מערב אפריקה (קיץ)", "COST": "שעון קולומביה (קיץ)", "AEDT": "שעון מזרח אוסטרליה (קיץ)", "OEZ": "שעון מזרח אירופה (חורף)", "OESZ": "שעון מזרח אירופה (קיץ)", "HNNOMX": "שעון צפון-מערב מקסיקו (חורף)", "SAST": "שעון דרום אפריקה", "HEPMX": "שעון מערב מקסיקו (קיץ)", "CHAST": "שעון צ׳טהאם (חורף)", "CHADT": "שעון צ׳טהאם (קיץ)", "CST": "שעון מרכז ארה״ב (חורף)", "HNOG": "שעון מערב גרינלנד (חורף)", "HEOG": "שעון מערב גרינלנד (קיץ)", "AWDT": "שעון מערב אוסטרליה (קיץ)", "HNCU": "שעון קובה (חורף)", "HAT": "שעון ניופאונדלנד (קיץ)", "GFT": "שעון גיאנה הצרפתית", "EAT": "שעון מזרח אפריקה", "JST": "שעון יפן (חורף)", "BOT": "שעון בוליביה", "HNPMX": "שעון מערב מקסיקו (חורף)", "TMT": "שעון טורקמניסטן (חורף)", "CLT": "שעון צ׳ילה (חורף)", "SRT": "שעון סורינאם", "HKT": "שעון הונג קונג (חורף)", "WART": "שעון מערב ארגנטינה (חורף)", "NZDT": "שעון ניו זילנד (קיץ)", "EDT": "שעון החוף המזרחי (קיץ)", "ACWST": "שעון מרכז-מערב אוסטרליה (חורף)", "∅∅∅": "שעון האיים האזוריים (קיץ)", "TMST": "שעון טורקמניסטן (קיץ)", "PST": "שעון מערב ארה״ב (חורף)", "ACWDT": "שעון מרכז-מערב אוסטרליה (קיץ)", "AEST": "שעון מזרח אוסטרליה (חורף)", "UYT": "שעון אורוגוואי (חורף)", "UYST": "שעון אורוגוואי (קיץ)", "COT": "שעון קולומביה (חורף)"},
	}
}
