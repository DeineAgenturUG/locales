...
func New() locales.Translator {
	return &ur_PK{
		...
		timezones:          map[string]string{"MDT": "ماؤنٹین ڈے لائٹ ٹائم", "HAT": "نیو فاؤنڈ لینڈ ڈے لائٹ ٹائم", "HNPMX": "میکسیکن پیسفک اسٹینڈرڈ ٹائم", "AWST": "آسٹریلیا ویسٹرن اسٹینڈرڈ ٹائم", "HNT": "نیو فاؤنڈ لینڈ اسٹینڈرڈ ٹائم", "MESZ": "وسطی یورپ کا موسم گرما کا وقت", "ACWDT": "آسٹریلین سنٹرل ویسٹرن ڈے لائٹ ٹائم", "HADT": "ہوائی الیوٹیئن ڈے لائٹ ٹائم", "COT": "کولمبیا کا معیاری وقت", "HNOG": "مغربی گرین لینڈ اسٹینڈرڈ ٹائم", "TMT": "ترکمانستان کا معیاری وقت", "HNCU": "کیوبا اسٹینڈرڈ ٹائم", "SAST": "جنوبی افریقہ سٹینڈرڈ ٹائم", "AKST": "الاسکا اسٹینڈرڈ ٹائم", "ACST": "آسٹریلین سنٹرل اسٹینڈرڈ ٹائم", "CLST": "چلی کا موسم گرما کا وقت", "GYT": "گیانا کا وقت", "MST": "ماؤنٹین اسٹینڈرڈ ٹائم", "PDT": "پیسفک ڈے لائٹ ٹائم", "MEZ": "وسطی یورپ کا معیاری وقت", "CST": "سنٹرل اسٹینڈرڈ ٹائم", "HKT": "ہانگ کانگ سٹینڈرڈ ٹائم", "NZST": "نیوزی لینڈ کا معیاری وقت", "HNPM": "سینٹ پیئر اور مکلیئون اسٹینڈرڈ ٹائم", "WEZ": "مغربی یورپ کا معیاری وقت", "GMT": "گرین وچ کا اصل وقت", "WIT": "مشرقی انڈونیشیا ٹائم", "TMST": "ترکمانستان کا موسم گرما کا وقت", "VET": "وینزوئیلا کا وقت", "ChST": "چامورو سٹینڈرڈ ٹائم", "HEPMX": "میکسیکن پیسفک ڈے لائٹ ٹائم", "CLT": "چلی کا معیاری وقت", "HEPM": "سینٹ پیئر اور مکلیئون ڈے لائٹ ٹائم", "CDT": "سنٹرل ڈے لائٹ ٹائم", "ADT": "اٹلانٹک ڈے لائٹ ٹائم", "AWDT": "آسٹریلین ویسٹرن ڈے لائٹ ٹائم", "WARST": "مغربی ارجنٹینا کا موسم گرما کا وقت", "HNEG": "مشرقی گرین لینڈ اسٹینڈرڈ ٹائم", "BOT": "بولیویا کا وقت", "ART": "ارجنٹینا سٹینڈرڈ ٹائم", "UYST": "یوروگوئے کا موسم گرما کا وقت", "JST": "جاپان سٹینڈرڈ ٹائم", "∅∅∅": "ازوریس کا موسم گرما کا وقت", "OESZ": "مشرقی یورپ کا موسم گرما کا وقت", "HENOMX": "شمال مغربی میکسیکو ڈے لائٹ ٹائم", "HEEG": "مشرقی گرین لینڈ کا موسم گرما کا وقت", "MYT": "ملیشیا ٹائم", "AST": "اٹلانٹک اسٹینڈرڈ ٹائم", "AEST": "آسٹریلین ایسٹرن اسٹینڈرڈ ٹائم", "HKST": "ہانگ کانگ سمر ٹائم", "CHADT": "چیتھم ڈے لائٹ ٹائم", "ACDT": "آسٹریلین سنٹرل ڈے لائٹ ٹائم", "HAST": "ہوائی الیوٹیئن اسٹینڈرڈ ٹائم", "WAT": "مغربی افریقہ سٹینڈرڈ ٹائم", "CHAST": "چیتھم اسٹینڈرڈ ٹائم", "WESZ": "مغربی یورپ کا موسم گرما کا وقت", "HEOG": "مغربی گرین لینڈ کا موسم گرما کا وقت", "AEDT": "آسٹریلین ایسٹرن ڈے لائٹ ٹائم", "SGT": "سنگاپور سٹینڈرڈ ٹائم", "JDT": "جاپان ڈے لائٹ ٹائم", "NZDT": "نیوزی لینڈ ڈے لائٹ ٹائم", "ARST": "ارجنٹینا سمر ٹائم", "LHDT": "لارڈ ہووے ڈے لائٹ ٹائم", "COST": "کولمبیا کا موسم گرما کا وقت", "ACWST": "آسٹریلین سنٹرل ویسٹرن اسٹینڈرڈ ٹائم", "GFT": "فرینچ گیانا کا وقت", "WITA": "وسطی انڈونیشیا ٹائم", "HECU": "کیوبا ڈے لائٹ ٹائم", "HNNOMX": "شمال مغربی میکسیکو اسٹینڈرڈ ٹائم", "PST": "پیسفک اسٹینڈرڈ ٹائم", "CAT": "وسطی افریقہ ٹائم", "WIB": "مغربی انڈونیشیا ٹائم", "AKDT": "الاسکا ڈے لائٹ ٹائم", "IST": "ہندوستان کا معیاری وقت", "SRT": "سورینام کا وقت", "WART": "مغربی ارجنٹینا کا معیاری وقت", "WAST": "مغربی افریقہ سمر ٹائم", "ECT": "ایکواڈور کا وقت", "EAT": "مشرقی افریقہ ٹائم", "EST": "ایسٹرن اسٹینڈرڈ ٹائم", "EDT": "ایسٹرن ڈے لائٹ ٹائم", "LHST": "لارڈ ہووے اسٹینڈرڈ ٹائم", "OEZ": "مشرقی یورپ کا معیاری وقت", "BT": "بھوٹان کا وقت", "UYT": "یوروگوئے کا معیاری وقت"},
	}
}
