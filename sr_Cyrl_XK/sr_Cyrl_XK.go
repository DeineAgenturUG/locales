...
func New() locales.Translator {
	return &sr_Cyrl_XK{
		...
		timezones:              map[string]string{"CHAST": "Чатам, стандардно време", "LHST": "Лорд Хов, стандардно време", "MYT": "Малезија време", "ACWDT": "Аустралијско централно западно летње време", "ECT": "Еквадор време", "PDT": "Северноамеричко пацифичко летње време", "SAST": "Јужно-афричко време", "AKST": "Аљаска, стандардно време", "AST": "Атлантско стандардно време", "WIT": "Источно-индонезијско време", "COST": "Колумбија, летње време", "SRT": "Суринам време", "AEDT": "Аустралијско источно летње време", "OEZ": "Источноевропско стандардно време", "VET": "Венецуела време", "HEEG": "Источни Гренланд, летње време", "WIB": "Западно-индонезијско време", "ACST": "Аустралијско централно стандардно време", "∅∅∅": "Бразилија, летње време", "GFT": "Француска Гвајана време", "HNPMX": "Мексички Пацифик, стандардно време", "WAST": "Западно-афричко летње време", "HNNOMX": "Северозападни Мексико, стандардно време", "HNPM": "Сен Пјер и Микелон, стандардно време", "BT": "Бутан време", "SGT": "Сингапур, стандардно време", "OESZ": "Источноевропско летње време", "JST": "Јапанско стандардно време", "CLT": "Чиле, стандардно време", "TMT": "Туркменистан, стандардно време", "AKDT": "Аљаска, летње време", "WESZ": "Западноевропско летње време", "LHDT": "Лорд Хов, летње време", "EAT": "Источно-афричко време", "HNEG": "Источни Гренланд, стандардно време", "HEPM": "Сен Пјер и Микелон, летње време", "HADT": "Хавајско-алеутско летње време", "HAST": "Хавајско-алеутско стандардно време", "TMST": "Туркменистан, летње време", "ACDT": "Аустралијско централно летње време", "CDT": "Северноамеричко централно летње време", "GYT": "Гвајана време", "EST": "Северноамеричко источно стандардно време", "MST": "Макао стандардно време", "HKT": "Хонг Конг, стандардно време", "MESZ": "Средњеевропско летње време", "ART": "Аргентина, стандардно време", "CAT": "Централно-афричко време", "PST": "Северноамеричко пацифичко стандардно време", "BOT": "Боливија време", "HNOG": "Западни Гренланд, стандардно време", "CHADT": "Чатам, летње време", "GMT": "Средње време по Гриничу", "ADT": "Атлантско летње време", "WART": "Западна Аргентина, стандардно време", "WARST": "Западна Аргентина, летње време", "CST": "Северноамеричко централно стандардно време", "AEST": "Аустралијско источно стандардно време", "AWST": "Аустралијско западно стандардно време", "IST": "Индијско стандардно време", "UYT": "Уругвај, стандардно време", "HEPMX": "Мексички Пацифик, летње време", "ACWST": "Аустралијско централно западно стандардно време", "CLST": "Чиле, летње време", "NZDT": "Нови Зеланд, летње време", "HNT": "Њуфаундленд, стандардно време", "ARST": "Аргентина, летње време", "JDT": "Јапанско летње време", "MDT": "Макао летње рачунање времена", "WITA": "Централно-индонезијско време", "HAT": "Њуфаундленд, летње време", "MEZ": "Средњеевропско стандардно време", "ChST": "Чаморо време", "AWDT": "Аустралијско западно летње време", "HENOMX": "Северозападни Мексико, летње време", "EDT": "Северноамеричко источно летње време", "COT": "Колумбија, стандардно време", "WEZ": "Западноевропско стандардно време", "WAT": "Западно-афричко стандардно време", "UYST": "Уругвај, летње време", "HEOG": "Западни Гренланд, летње време", "HKST": "Хонг Конг, летње време", "NZST": "Нови Зеланд, стандардно време", "HNCU": "Куба, стандардно време", "HECU": "Куба, летње време"},
	}
}
