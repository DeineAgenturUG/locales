...
func New() locales.Translator {
	return &sv_FI{
		...
		timezones:              map[string]string{"AKST": "Alaska, normaltid", "HNPM": "S:t Pierre och Miquelon, normaltid", "AEDT": "östaustralisk sommartid", "SGT": "Singaporetid", "HNNOMX": "nordvästmexikansk normaltid", "HEEG": "östgrönländsk sommartid", "AKDT": "Alaska, sommartid", "IST": "indisk tid", "HAST": "Honolulu, normaltid", "HAT": "Newfoundland, sommartid", "HADT": "Honolulu, sommartid", "ACWST": "västcentralaustralisk normaltid", "GFT": "Franska Guyanatid", "UYST": "uruguayansk sommartid", "AEST": "östaustralisk normaltid", "AWDT": "västaustralisk sommartid", "HKT": "Hongkong, normaltid", "TMST": "turkmensk sommartid", "PST": "västnordamerikansk normaltid", "BOT": "boliviansk tid", "CDT": "centralnordamerikansk sommartid", "LHST": "Lord Howe, normaltid", "WAT": "västafrikansk normaltid", "COST": "colombiansk sommartid", "MDT": "Macausommartid", "AWST": "västaustralisk normaltid", "WIT": "östindonesisk tid", "WITA": "centralindonesisk tid", "HECU": "kubansk sommartid", "ARST": "östargentinsk sommartid", "LHDT": "Lord Howe, sommartid", "ACWDT": "västcentralaustralisk sommartid", "GMT": "Greenwichtid", "ECT": "ecuadoriansk tid", "ADT": "nordamerikansk atlantsommartid", "WART": "västargentinsk normaltid", "NZST": "nyzeeländsk normaltid", "VET": "venezuelansk tid", "ART": "östargentinsk normaltid", "ACST": "centralaustralisk normaltid", "CST": "centralnordamerikansk normaltid", "CLST": "chilensk sommartid", "COT": "colombiansk normaltid", "HEPMX": "mexikansk stillahavstid, sommartid", "OEZ": "östeuropeisk normaltid", "JDT": "japansk sommartid", "UYT": "uruguayansk normaltid", "WAST": "västafrikansk sommartid", "CLT": "chilensk normaltid", "SRT": "Surinamtid", "HEOG": "västgrönländsk sommartid", "JST": "japansk normaltid", "ACDT": "centralaustralisk sommartid", "CHAST": "Chatham, normaltid", "WESZ": "västeuropeisk sommartid", "∅∅∅": "Brasilia, sommartid", "ChST": "Chamorrotid", "MST": "Macaunormaltid", "BT": "bhutansk tid", "HEPM": "S:t Pierre och Miquelon, sommartid", "MYT": "malaysisk tid", "AST": "nordamerikansk atlantnormaltid", "HNOG": "västgrönländsk normaltid", "NZDT": "nyzeeländsk sommartid", "HNCU": "kubansk normaltid", "MESZ": "centraleuropeisk sommartid", "CAT": "centralafrikansk tid", "WEZ": "västeuropeisk normaltid", "OESZ": "östeuropeisk sommartid", "WIB": "västindonesisk tid", "HKST": "Hongkong, sommartid", "EAT": "östafrikansk tid", "MEZ": "centraleuropeisk normaltid", "HNPMX": "mexikansk stillahavstid, normaltid", "WARST": "västargentinsk sommartid", "HNT": "Newfoundland, normaltid", "EDT": "östnordamerikansk sommartid", "GYT": "Guyanatid", "PDT": "västnordamerikansk sommartid", "SAST": "sydafrikansk tid", "HNEG": "östgrönländsk normaltid", "CHADT": "Chatham, sommartid", "HENOMX": "nordvästmexikansk sommartid", "EST": "östnordamerikansk normaltid", "TMT": "turkmensk normaltid"},
	}
}
