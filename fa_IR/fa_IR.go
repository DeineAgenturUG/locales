...
func New() locales.Translator {
	return &fa_IR{
		...
		timezones:              map[string]string{"BOT": "وقت بولیوی", "MEZ": "وقت عادی مرکز اروپا", "BT": "وقت بوتان", "IST": "وقت هند", "EDT": "وقت تابستانی شرق امریکا", "HNOG": "وقت عادی غرب گرینلند", "WART": "وقت عادی غرب آرژانتین", "∅∅∅": "وقت تابستانی آزور", "CHAST": "وقت عادی چت\u200cهام", "EST": "وقت عادی شرق امریکا", "ACWST": "وقت عادی مرکز-غرب استرالیا", "CLT": "وقت عادی شیلی", "CLST": "وقت تابستانی شیلی", "AST": "وقت عادی آتلانتیک", "OESZ": "وقت تابستانی شرق اروپا", "HNNOMX": "وقت عادی شمال غرب مکزیک", "HENOMX": "وقت تابستانی شمال غرب مکزیک", "HNEG": "وقت عادی شرق گرینلند", "HNPM": "وقت عادی سنت\u200cپیر و میکلون", "SRT": "وقت سورینام", "EAT": "وقت شرق افریقا", "HAT": "وقت تابستانی نیوفاندلند", "HEPM": "وقت تابستانی سنت\u200cپیر و میکلون", "WEZ": "وقت عادی غرب اروپا", "ChST": "وقت عادی چامورو", "HEPMX": "وقت تابستانی شرق مکزیک", "HEOG": "وقت تابستانی غرب گرینلند", "HECU": "وقت تابستانی کوبا", "CDT": "وقت تابستانی مرکز امریکا", "JDT": "وقت تابستانی ژاپن", "ACST": "وقت عادی مرکز استرالیا", "JST": "وقت عادی ژاپن", "VET": "وقت ونزوئلا", "AKDT": "وقت تابستانی آلاسکا", "WAT": "وقت عادی غرب افریقا", "WAST": "وقت تابستانی غرب افریقا", "HKT": "وقت عادی هنگ\u200cکنگ", "OEZ": "وقت عادی شرق اروپا", "ACDT": "وقت تابستانی مرکز استرالیا", "ADT": "وقت تابستانی آتلانتیک", "SAST": "وقت عادی جنوب افریقا", "GMT": "وقت گرینویچ", "ECT": "وقت اکوادور", "WIB": "وقت غرب اندونزی", "LHST": "وقت عادی لردهو", "AEST": "وقت عادی شرق استرالیا", "AEDT": "وقت تابستانی شرق استرالیا", "ARST": "وقت تابستانی آرژانتین", "CST": "وقت عادی مرکز امریکا", "WESZ": "وقت تابستانی غرب اروپا", "MYT": "وقت مالزی", "ACWDT": "وقت تابستانی مرکز-غرب استرالیا", "COST": "وقت تابستانی کلمبیا", "GYT": "وقت گویان", "MESZ": "وقت تابستانی مرکز اروپا", "HNT": "وقت عادی نیوفاندلند", "ART": "وقت عادی آرژانتین", "HADT": "وقت تابستانی هاوایی‐الوشن", "COT": "وقت عادی کلمبیا", "WITA": "وقت مرکز اندونزی", "HNCU": "وقت عادی کوبا", "PST": "وقت عادی غرب امریکا", "HEEG": "وقت تابستانی شرق گرینلند", "AKST": "وقت عادی آلاسکا", "GFT": "وقت گویان فرانسه", "HNPMX": "وقت عادی شرق مکزیک", "MST": "وقت عادی ماکائو", "HKST": "وقت تابستانی هنگ\u200cکنگ", "LHDT": "وقت تابستانی لردهو", "UYT": "وقت عادی اروگوئه", "UYST": "وقت تابستانی اروگوئه", "TMST": "وقت تابستانی ترکمنستان", "WARST": "وقت تابستانی غرب آرژانتین", "WIT": "وقت شرق اندونزی", "NZDT": "وقت تابستانی زلاند نو", "PDT": "وقت تابستانی غرب امریکا", "MDT": "وقت تابستانی ماکائو", "AWST": "وقت عادی غرب استرالیا", "HAST": "وقت عادی هاوایی‐الوشن", "AWDT": "وقت تابستانی غرب استرالیا", "CAT": "وقت مرکز افریقا", "NZST": "وقت عادی زلاند نو", "CHADT": "وقت تابستانی چت\u200cهام", "SGT": "وقت سنگاپور", "TMT": "وقت عادی ترکمنستان"},
	}
}
