...
func New() locales.Translator {
	return &ru_MD{
		...
		timezones:              map[string]string{"ACDT": "Центральная Австралия, летнее время", "HNPM": "Сен-Пьер и Микелон, стандартное время", "WAST": "Западная Африка, летнее время", "TMST": "Туркменистан, летнее время", "HAT": "Ньюфаундленд, летнее время", "CDT": "Центральная Америка, летнее время", "HNNOMX": "Северо-западное мексиканское стандартное время", "NZST": "Новая Зеландия, стандартное время", "ART": "Аргентина, стандартное время", "ARST": "Аргентина, летнее время", "AKST": "Аляска, стандартное время", "EST": "Восточная Америка, стандартное время", "UYST": "Уругвай, летнее время", "ECT": "Эквадор", "HEOG": "Западная Гренландия, летнее время", "OEZ": "Восточная Европа, стандартное время", "WART": "Западная Аргентина, стандартное время", "WARST": "Западная Аргентина, летнее время", "LHST": "Лорд-Хау, стандартное время", "LHDT": "Лорд-Хау, летнее время", "∅∅∅": "Бразилия, летнее время", "AEDT": "Восточная Австралия, летнее время", "ADT": "Атлантическое летнее время", "HNEG": "Восточная Гренландия, стандарное время", "WIB": "Западная Индонезия", "EDT": "Восточная Америка, летнее время", "ChST": "Чаморро", "EAT": "Восточная Африка", "WESZ": "Западная Европа, летнее время", "AWST": "Западная Австралия, стандартное время", "CST": "Центральная Америка, стандартное время", "CLST": "Чили, летнее время", "HNPMX": "Тихоокеанское мексиканское стандартное время", "MDT": "Макао, летнее время", "OESZ": "Восточная Европа, летнее время", "NZDT": "Новая Зеландия, летнее время", "GFT": "Французская Гвиана", "AEST": "Восточная Австралия, стандартное время", "AST": "Атлантическое стандартное время", "PDT": "Тихоокеанское летнее время", "BOT": "Боливия", "HEEG": "Восточная Гренландия, летнее время", "JDT": "Япония, летнее время", "CAT": "Центральная Африка", "IST": "Индия", "HAST": "Гавайско-алеутское стандартное время", "HADT": "Гавайско-алеутское летнее время", "HKT": "Гонконг, стандартное время", "AWDT": "Западная Австралия, летнее время", "WITA": "Центральная Индонезия", "COST": "Колумбия, летнее время", "WIT": "Восточная Индонезия", "JST": "Япония, стандартное время", "HENOMX": "Северо-западное мексиканское летнее время", "MESZ": "Центральная Европа, летнее время", "AKDT": "Аляска, летнее время", "BT": "Бутан", "ACWDT": "Центральная Австралия, западное летнее время", "HKST": "Гонконг, летнее время", "HECU": "Куба, летнее время", "PST": "Тихоокеанское стандартное время", "SAST": "Южная Африка", "MEZ": "Центральная Европа, стандартное время", "ACST": "Центральная Австралия, стандартное время", "HEPM": "Сен-Пьер и Микелон, летнее время", "COT": "Колумбия, стандартное время", "HEPMX": "Тихоокеанское мексиканское летнее время", "SRT": "Суринам", "SGT": "Сингапур", "HNCU": "Куба, стандартное время", "HNT": "Ньюфаундленд, стандартное время", "WEZ": "Западная Европа, стандартное время", "MYT": "Малайзия", "UYT": "Уругвай, стандартное время", "GYT": "Гайана", "MST": "Макао, стандартное время", "HNOG": "Западная Гренландия, стандартное время", "VET": "Венесуэла", "CHAST": "Чатем, стандартное время", "CLT": "Чили, стандартное время", "GMT": "Среднее время по Гринвичу", "CHADT": "Чатем, летнее время", "ACWST": "Центральная Австралия, западное стандартное время", "WAT": "Западная Африка, стандартное время", "TMT": "Туркменистан, стандартное время"},
	}
}
