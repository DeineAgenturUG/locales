...
func New() locales.Translator {
	return &sr_Latn_ME{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"MST": "Макао стандардно време", "HEOG": "Западни Гренланд, летње време", "WARST": "Западна Аргентина, летње време", "WAT": "Западно-афричко стандардно време", "ACWDT": "Аустралијско централно западно летње време", "GYT": "Гвајана време", "HKT": "Хонг Конг, стандардно време", "HECU": "Куба, летње време", "ART": "Аргентина, стандардно време", "NZDT": "Нови Зеланд, летње време", "HAT": "Њуфаундленд, летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "WEZ": "Западноевропско стандардно време", "WIT": "Источно-индонезијско време", "TMT": "Туркменистан, стандардно време", "OEZ": "Источноевропско стандардно време", "VET": "Венецуела време", "ACWST": "Аустралијско централно западно стандардно време", "SRT": "Суринам време", "CLT": "Чиле, стандардно време", "GMT": "Средње време по Гриничу", "AEST": "Аустралијско источно стандардно време", "SAST": "Јужно-афричко време", "CST": "Северноамеричко централно стандардно време", "MYT": "Малезија време", "LHST": "Лорд Хов, стандардно време", "COT": "Колумбија, стандардно време", "WAST": "Западно-афричко летње време", "SGT": "Сингапур, стандардно време", "BT": "Бутан време", "ChST": "Чаморо време", "UYT": "Уругвај, стандардно време", "ARST": "Аргентина, летње време", "MESZ": "Средњеевропско летње време", "IST": "Индијско стандардно време", "∅∅∅": "Азори, летње време", "WART": "Западна Аргентина, стандардно време", "HEEG": "Источни Гренланд, летње време", "ECT": "Еквадор време", "ACST": "Аустралијско централно стандардно време", "HADT": "Хавајско-алеутско летње време", "HNPMX": "Мексички Пацифик, стандардно време", "JDT": "Јапанско летње време", "NZST": "Нови Зеланд, стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "HNT": "Њуфаундленд, стандардно време", "HEPMX": "Мексички Пацифик, летње време", "ADT": "Атлантско летње време", "JST": "Јапанско стандардно време", "TMST": "Туркменистан, летње време", "HENOMX": "Северозападни Мексико, летње време", "WESZ": "Западноевропско летње време", "AEDT": "Аустралијско источно летње време", "PDT": "Северноамеричко пацифичко летње време", "CHAST": "Чатам, стандардно време", "CLST": "Чиле, летње време", "COST": "Колумбија, летње време", "AWDT": "Аустралијско западно летње време", "BOT": "Боливија време", "HNEG": "Источни Гренланд, стандардно време", "HAST": "Хавајско-алеутско стандардно време", "AKST": "Аљаска, стандардно време", "CDT": "Северноамеричко централно летње време", "GFT": "Француска Гвајана време", "MDT": "Макао летње рачунање времена", "WIB": "Западно-индонезијско време", "ACDT": "Аустралијско централно летње време", "CHADT": "Чатам, летње време", "HEPM": "Сен Пјер и Микелон, летње време", "CAT": "Централно-афричко време", "WITA": "Централно-индонезијско време", "EAT": "Источно-афричко време", "HNNOMX": "Северозападни Мексико, стандардно време", "AKDT": "Аљаска, летње време", "LHDT": "Лорд Хов, летње време", "UYST": "Уругвај, летње време", "HNOG": "Западни Гренланд, стандардно време", "AWST": "Аустралијско западно стандардно време", "OESZ": "Источноевропско летње време", "EST": "Северноамеричко источно стандардно време", "EDT": "Северноамеричко источно летње време", "HKST": "Хонг Конг, летње време", "HNCU": "Куба, стандардно време", "MEZ": "Средњеевропско стандардно време", "AST": "Атлантско стандардно време"},
	}
}
