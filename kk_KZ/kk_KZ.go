...
func New() locales.Translator {
	return &kk_KZ{
		...
		timezones:              map[string]string{"HKST": "Гонконг жазғы уақыты", "OESZ": "Шығыс Еуропа жазғы уақыты", "CHADT": "Чатем жазғы уақыты", "IST": "Үндістан стандартты уақыты", "LHDT": "Лорд-Хау жазғы уақыты", "GMT": "Гринвич уақыты", "AWDT": "Австралия жазғы батыс уақыты", "TMT": "Түрікменстан стандартты уақыты", "OEZ": "Шығыс Еуропа стандартты уақыты", "BOT": "Боливия уақыты", "HADT": "Гавай және Алеут аралдары жазғы уақыты", "GYT": "Гайана уақыты", "MST": "MST", "CST": "Солтүстік Америка стандартты орталық уақыты", "WEZ": "Батыс Еуропа стандартты уақыты", "WART": "Батыс Аргентина стандартты уақыты", "HNT": "Ньюфаундленд стандартты уақыты", "HEPM": "Сен-Пьер және Микелон жазғы уақыты", "CLST": "Чили жазғы уақыты", "ChST": "Чаморро стандартты уақыты", "WIT": "Шығыс Индонезия уақыты", "JDT": "Жапония жазғы уақыты", "HNNOMX": "Солтүстік-батыс Мексика стандартты уақыты", "HENOMX": "Солтүстік-батыс Мексика жазғы уақыты", "NZDT": "Жаңа Зеландия жазғы уақыты", "HECU": "Куба жазғы уақыты", "LHST": "Лорд-Хау стандартты уақыты", "ACWST": "Австралия стандартты орталық-батыс уақыты", "TMST": "Түрікменстан жазғы уақыты", "PST": "Солтүстік Америка стандартты Тынық мұхиты уақыты", "WESZ": "Батыс Еуропа жазғы уақыты", "WAT": "Батыс Африка стандартты уақыты", "SGT": "Сингапур стандартты уақыты", "SAST": "Оңтүстік Африка уақыты", "AKST": "Аляска стандартты уақыты", "VET": "Венесуэла уақыты", "HEEG": "Шығыс Гренландия жазғы уақыты", "HNPM": "Сен-Пьер және Микелон стандартты уақыты", "CAT": "Орталық Африка уақыты", "HNPMX": "Мексика стандартты Тынық мұхит уақыты", "COST": "Колумбия жазғы уақыты", "ADT": "Атлантика жазғы уақыты", "∅∅∅": "Азор аралдары жазғы уақыты", "WITA": "Орталық Индонезия уақыты", "HAT": "Ньюфаундленд жазғы уақыты", "HAST": "Гавай және Алеут аралдары стандартты уақыты", "COT": "Колумбия стандартты уақыты", "SRT": "Суринам уақыты", "MDT": "MDT", "HEOG": "Батыс Гренландия жазғы уақыты", "AWST": "Австралия стандартты батыс уақыты", "WIB": "Батыс Индонезия уақыты", "CHAST": "Чатем стандартты уақыты", "HEPMX": "Мексика жазғы Тынық мұхит уақыты", "AST": "Атлантика стандартты уақыты", "AEST": "Австралия стандартты шығыс уақыты", "ACWDT": "Австралия жазғы орталық-батыс уақыты", "HKT": "Гонконг стандартты уақыты", "PDT": "Солтүстік Америка жазғы Тынық мұхиты уақыты", "HNEG": "Шығыс Гренландия стандартты уақыты", "ARST": "Аргентина жазғы уақыты", "EDT": "Солтүстік Америка жазғы шығыс уақыты", "GFT": "Француз Гвианасы уақыты", "UYST": "Уругвай жазғы уақыты", "ECT": "Эквадор уақыты", "HNOG": "Батыс Гренландия стандартты уақыты", "CLT": "Чили стандартты уақыты", "AEDT": "Австралия жазғы шығыс уақыты", "EAT": "Шығыс Африка уақыты", "NZST": "Жаңа Зеландия стандартты уақыты", "HNCU": "Куба стандартты уақыты", "AKDT": "Аляска жазғы уақыты", "ACDT": "Австралия жазғы орталық уақыты", "EST": "Солтүстік Америка стандартты шығыс уақыты", "UYT": "Уругвай стандартты уақыты", "JST": "Жапония стандартты уақыты", "ART": "Аргентина стандартты уақыты", "BT": "Бутан уақыты", "CDT": "Солтүстік Америка жазғы орталық уақыты", "WARST": "Батыс Аргентина жазғы уақыты", "MEZ": "Орталық Еуропа стандартты уақыты", "MESZ": "Орталық Еуропа жазғы уақыты", "ACST": "Австралия стандартты орталық уақыты", "MYT": "Малайзия уақыты", "WAST": "Батыс Африка жазғы уақыты"},
	}
}
