...
func New() locales.Translator {
	return &be{
		...
		timezones:              map[string]string{"HKT": "Стандартны час Ганконга", "HECU": "Летні час Кубы", "CHAST": "Стандартны час Чатэма", "IST": "Час Індыі", "GMT": "Час па Грынвічы", "AST": "Атлантычны стандартны час", "AWST": "Стандартны час заходняй Аўстраліі", "AWDT": "Летні час заходняй Аўстраліі", "OEZ": "Усходнееўрапейскі стандартны час", "SAST": "Паўднёваафрыканскі час", "WIB": "Заходнеінданезійскі час", "COT": "Калумбійскі стандартны час", "WARST": "Летні час Заходняй Аргенціны", "HAT": "Ньюфаўндлендскі летні час", "CAT": "Цэнтральнаафрыканскі час", "CHADT": "Летні час Чатэма", "LHST": "Стандартны час Лорд-Хау", "UYT": "Уругвайскі стандартны час", "ECT": "Эквадорскі час", "NZDT": "Летні час Новай Зеландыі", "BOT": "Балівійскі час", "AKDT": "Летні час Аляскі", "EDT": "Паўночнаамерыканскі ўсходні летні час", "COST": "Калумбійскі летні час", "AEDT": "Летні час усходняй Аўстраліі", "HKST": "Летні час Ганконга", "ACST": "Стандартны час цэнтральнай Аўстраліі", "ChST": "Час Чамора", "WAT": "Заходнеафрыканскі стандартны час", "CLST": "Чылійскі летні час", "HNNOMX": "Паўночна-заходні мексіканскі стандартны час", "ACDT": "Летні час цэнтральнай Аўстраліі", "GYT": "Час Гаяны", "EST": "Паўночнаамерыканскі ўсходні стандартны час", "LHDT": "Летні час Лорд-Хау", "JST": "Стандартны час Японіі", "HENOMX": "Паўночна-заходні мексіканскі летні час", "VET": "Венесуэльскі час", "PDT": "Ціхаакіянскі летні час", "HEEG": "Летні час Усходняй Грэнландыі", "AKST": "Стандартны час Аляскі", "TMST": "Летні час Туркменістана", "HNEG": "Стандартны час Усходняй Грэнландыі", "HNPM": "Стандартны час Сен-П’ер і Мікелон", "HNPMX": "Мексіканскі ціхаакіянскі стандатны час", "UYST": "Уругвайскі летні час", "SRT": "Час Сурынама", "ADT": "Атлантычны летні час", "WART": "Стандартны час Заходняй Аргенціны", "HNCU": "Стандартны час Кубы", "MESZ": "Цэнтральнаеўрапейскі летні час", "BT": "Час Бутана", "GFT": "Час Французскай Гвіяны", "HEPMX": "Мексіканскі ціхаакіянскі летні час", "SGT": "Сінгапурскі час", "PST": "Ціхаакіянскі стандартны час", "ARST": "Аргенцінскі летні час", "WESZ": "Заходнееўрапейскі летні час", "MYT": "Час Малайзіі", "MST": "MST", "AEST": "Стандартны час усходняй Аўстраліі", "OESZ": "Усходнееўрапейскі летні час", "HAST": "Гавайска-Алеуцкі стандартны час", "ACWST": "Стандартны цэнтральна-заходні час Аўстраліі", "ACWDT": "Летні цэнтральна-заходні час Аўстраліі", "MDT": "MDT", "TMT": "Стандартны час Туркменістана", "JDT": "Летні час Японіі", "NZST": "Стандартны час Новай Зеландыі", "CDT": "Паўночнаамерыканскі цэнтральны летні час", "CLT": "Чылійскі стандартны час", "HNOG": "Стандартны час Заходняй Грэнландыі", "HEOG": "Летні час Заходняй Грэнландыі", "∅∅∅": "Летні час Азорскіх астравоў", "HADT": "Гавайска-Алеуцкі летні час", "WIT": "Усходнеінданезійскі час", "WITA": "Цэнтральнаінданезійскі час", "MEZ": "Цэнтральнаеўрапейскі стандартны час", "CST": "Паўночнаамерыканскі цэнтральны стандартны час", "EAT": "Усходнеафрыканскі час", "HNT": "Ньюфаўндлендскі стандартны час", "ART": "Аргенцінскі стандартны час", "HEPM": "Стандартны летні час Сен-П’ер і Мікелон", "WEZ": "Заходнееўрапейскі стандартны час", "WAST": "Заходнеафрыканскі летні час"},
	}
}
