...
func New() locales.Translator {
	return &sr_Cyrl_ME{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"CHADT": "Чатам, летње време", "GMT": "Средње време по Гриничу", "∅∅∅": "Азори, летње време", "PDT": "Северноамеричко пацифичко летње време", "ACST": "Аустралијско централно стандардно време", "JST": "Јапанско стандардно време", "AKST": "Аљаска, стандардно време", "CAT": "Централно-афричко време", "WESZ": "Западноевропско летње време", "EDT": "Северноамеричко источно летње време", "UYT": "Уругвај, стандардно време", "MDT": "Макао летње рачунање времена", "AWST": "Аустралијско западно стандардно време", "WART": "Западна Аргентина, стандардно време", "WAT": "Западно-афричко стандардно време", "ACWST": "Аустралијско централно западно стандардно време", "HNOG": "Западни Гренланд, стандардно време", "HEPM": "Сен Пјер и Микелон, летње време", "WEZ": "Западноевропско стандардно време", "ADT": "Атлантско летње време", "VET": "Венецуела време", "ACWDT": "Аустралијско централно западно летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "LHST": "Лорд Хов, стандардно време", "LHDT": "Лорд Хов, летње време", "UYST": "Уругвај, летње време", "CLST": "Чиле, летње време", "HEOG": "Западни Гренланд, летње време", "WARST": "Западна Аргентина, летње време", "MEZ": "Средњеевропско стандардно време", "NZDT": "Нови Зеланд, летње време", "PST": "Северноамеричко пацифичко стандардно време", "HNT": "Њуфаундленд, стандардно време", "ARST": "Аргентина, летње време", "WIB": "Западно-индонезијско време", "HKT": "Хонг Конг, стандардно време", "OESZ": "Источноевропско летње време", "JDT": "Јапанско летње време", "COST": "Колумбија, летње време", "HENOMX": "Северозападни Мексико, летње време", "MESZ": "Средњеевропско летње време", "ACDT": "Аустралијско централно летње време", "CLT": "Чиле, стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "ECT": "Еквадор време", "OEZ": "Источноевропско стандардно време", "TMST": "Туркменистан, летње време", "HEPMX": "Мексички Пацифик, летње време", "SAST": "Јужно-афричко време", "CST": "Северноамеричко централно стандардно време", "EST": "Северноамеричко источно стандардно време", "HAT": "Њуфаундленд, летње време", "HEEG": "Источни Гренланд, летње време", "HAST": "Хавајско-алеутско стандардно време", "GYT": "Гвајана време", "AST": "Атлантско стандардно време", "TMT": "Туркменистан, стандардно време", "HECU": "Куба, летње време", "GFT": "Француска Гвајана време", "WAST": "Западно-афричко летње време", "COT": "Колумбија, стандардно време", "MST": "Макао стандардно време", "AWDT": "Аустралијско западно летње време", "HADT": "Хавајско-алеутско летње време", "BOT": "Боливија време", "ChST": "Чаморо време", "HKST": "Хонг Конг, летње време", "NZST": "Нови Зеланд, стандардно време", "HNNOMX": "Северозападни Мексико, стандардно време", "SGT": "Сингапур, стандардно време", "HNEG": "Источни Гренланд, стандардно време", "BT": "Бутан време", "IST": "Индијско стандардно време", "SRT": "Суринам време", "WITA": "Централно-индонезијско време", "AKDT": "Аљаска, летње време", "ART": "Аргентина, стандардно време", "CHAST": "Чатам, стандардно време", "AEST": "Аустралијско источно стандардно време", "WIT": "Источно-индонезијско време", "EAT": "Источно-афричко време", "MYT": "Малезија време", "AEDT": "Аустралијско источно летње време", "HNCU": "Куба, стандардно време", "CDT": "Северноамеричко централно летње време"},
	}
}
