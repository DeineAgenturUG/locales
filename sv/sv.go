...
func New() locales.Translator {
	return &sv{
		...
		timezones:              map[string]string{"LHDT": "Lord Howe, sommartid", "ACWDT": "västcentralaustralisk sommartid", "HKST": "Hongkong, sommartid", "WITA": "centralindonesisk tid", "TMST": "turkmensk sommartid", "VET": "venezuelansk tid", "CHADT": "Chatham, sommartid", "HEPM": "S:t Pierre och Miquelon, sommartid", "AWST": "västaustralisk normaltid", "OEZ": "östeuropeisk normaltid", "IST": "indisk tid", "WAT": "västafrikansk normaltid", "CLST": "chilensk sommartid", "HNPMX": "mexikansk stillahavstid, normaltid", "EDT": "östnordamerikansk sommartid", "HNT": "Newfoundland, normaltid", "HEEG": "östgrönländsk sommartid", "CDT": "centralnordamerikansk sommartid", "WESZ": "västeuropeisk sommartid", "EST": "östnordamerikansk normaltid", "CHAST": "Chatham, normaltid", "UYT": "uruguayansk normaltid", "AEST": "östaustralisk normaltid", "AWDT": "västaustralisk sommartid", "HKT": "Hongkong, normaltid", "EAT": "östafrikansk tid", "JDT": "japansk sommartid", "PST": "västnordamerikansk normaltid", "WAST": "västafrikansk sommartid", "MDT": "Macausommartid", "HNEG": "östgrönländsk normaltid", "ACST": "centralaustralisk normaltid", "CST": "centralnordamerikansk normaltid", "OESZ": "östeuropeisk sommartid", "WART": "västargentinsk normaltid", "WARST": "västargentinsk sommartid", "HNCU": "kubansk normaltid", "HNNOMX": "nordvästmexikansk normaltid", "GFT": "Franska Guyanatid", "CLT": "chilensk normaltid", "BOT": "boliviansk tid", "COST": "colombiansk sommartid", "AEDT": "östaustralisk sommartid", "WIT": "östindonesisk tid", "UYST": "uruguayansk sommartid", "COT": "colombiansk normaltid", "HNOG": "västgrönländsk normaltid", "JST": "japansk normaltid", "∅∅∅": "azorisk sommartid", "PDT": "västnordamerikansk sommartid", "SAST": "sydafrikansk tid", "HAST": "Honolulu, normaltid", "MESZ": "centraleuropeisk sommartid", "ACDT": "centralaustralisk sommartid", "ECT": "ecuadoriansk tid", "TMT": "turkmensk normaltid", "HENOMX": "nordvästmexikansk sommartid", "AKDT": "Alaska, sommartid", "BT": "bhutansk tid", "MYT": "malaysisk tid", "AST": "nordamerikansk atlantnormaltid", "HECU": "kubansk sommartid", "CAT": "centralafrikansk tid", "WIB": "västindonesisk tid", "SRT": "Surinamtid", "MST": "Macaunormaltid", "ART": "östargentinsk normaltid", "LHST": "Lord Howe, normaltid", "ChST": "Chamorrotid", "ACWST": "västcentralaustralisk normaltid", "HEPMX": "mexikansk stillahavstid, sommartid", "HEOG": "västgrönländsk sommartid", "GMT": "Greenwichtid", "GYT": "Guyanatid", "SGT": "Singaporetid", "NZST": "nyzeeländsk normaltid", "NZDT": "nyzeeländsk sommartid", "HAT": "Newfoundland, sommartid", "ARST": "östargentinsk sommartid", "HADT": "Honolulu, sommartid", "HNPM": "S:t Pierre och Miquelon, normaltid", "WEZ": "västeuropeisk normaltid", "ADT": "nordamerikansk atlantsommartid", "AKST": "Alaska, normaltid", "MEZ": "centraleuropeisk normaltid"},
	}
}
