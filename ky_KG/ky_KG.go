...
func New() locales.Translator {
	return &ky_KG{
		...
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"ChST": "Чаморро убактысы", "ACWST": "Австралия борбордук батыш кышкы убакыты", "AWST": "Австралия батыш кышкы убакыты", "SGT": "Сингапур убактысы", "TMT": "Түркмөнстан кышкы убакыты", "AKST": "Аляска кышкы убактысы", "ACST": "Австралия борбордук кышкы убакыты", "CDT": "Түндүк Америка, борбордук жайкы убакыт", "EAT": "Чыгыш Африка убактысы", "OEZ": "Чыгыш Европа кышкы убакыты", "MDT": "MDT", "JDT": "Жапон жайкы убактысы", "HNCU": "Куба кышкы убактысы", "HENOMX": "Түндүк-чыгыш Мексика жайкы убактысы", "HNPM": "Сен Пьер жана Микелон кышкы убактысы", "UYST": "Уругвай жайкы убактысы", "CLT": "Чили кышкы убактысы", "ACWDT": "Австралия борбордук чыгыш жайкы убактысы", "OESZ": "Чыгыш Европа жайкы убактысы", "WART": "Батыш Аргентина кышкы убактысы", "HNNOMX": "Түндүк-чыгыш Мексика кышкы убактысы", "ARST": "Аргентина жайкы убактысы", "IST": "Индия убактысы", "HNPMX": "Мексика, Тынч океан кышкы убактысы", "HEOG": "Батыш Гренландия жайкы убактысы", "JST": "Жапон кышкы убакыты", "WITA": "Борбордук Индонезия убактысы", "HAT": "Нюфаундлэнд жайкы убактысы", "∅∅∅": "Бразилия жайкы убактысы", "HAST": "Гавайи-Алеут кышкы убактысы", "ADT": "Атлантика жайкы убактысы", "NZDT": "Жаңы Зеландия жайкы убакыты", "BOT": "Боливия убактысы", "HEPMX": "Мексика, Тынч океан жайкы убактысы", "GYT": "Гвиана убактысы", "WESZ": "Батыш Европа жайкы убактысы", "EDT": "Түндүк Америка, чыгыш жайкы убактысы", "LHDT": "Лорд Хау жайкы убактысы", "COST": "Колумбия жайкы убактысы", "AEST": "Австралия чыгыш кышкы убакыты", "HNEG": "Чыгыш Гренландия кышкы убактысы", "ART": "Аргентина кышкы убактысы", "WIB": "Батыш Индонезия убактысы", "HKT": "Гонконг кышкы убакыты", "GFT": "Француз Гвиана убактысы", "SRT": "Суринаме убактысы", "HNOG": "Батыш Гренландия кышкы убактысы", "ACDT": "Австралия борбордук жайкы убактысы", "EST": "Түндүк Америка, чыгыш кышкы убактысы", "HADT": "Гавайи-Алеут жайкы убактысы", "AEDT": "Австралия чыгыш жайкы убактысы", "HKST": "Гонконг жайкы убактысы", "CAT": "Борбордук Африка убактысы", "COT": "Колумбия кышкы убактысы", "AST": "Атлантика кышкы убактысы", "HECU": "Куба жайкы убактысы", "CHAST": "Чатам кышкы убакыт", "CHADT": "Чатам жайкы убактысы", "ECT": "Экуадор убактысы", "WAT": "Батыш Африка кышкы убакыты", "NZST": "Жаңы Зеландия кышкы убакыты", "WARST": "Батыш Аргентина жайкы убактысы", "PDT": "Түндүк Америка, Тынч океан жайкы убактысы", "CST": "Түндүк Америка, борбордук кышкы убактысы", "GMT": "Гринвич боюнча орточо убакыт", "PST": "Түндүк Америка, Тынч океан кышкы убактысы", "MEZ": "Борбордук Европа кышкы убакыты", "VET": "Венесуэла убактысы", "AWDT": "Австралия батыш жайкы убактысы", "HEEG": "Чыгыш Гренландия жайкы убактысы", "AKDT": "Аляска жайкы убактысы", "WEZ": "Батыш Европа кышкы убакыты", "MST": "MST", "HEPM": "Сен Пьер жана Микелон жайкы убактысы", "MYT": "Малайзия убактысы", "CLST": "Чили жайкы убактысы", "WIT": "Чыгыш Индонезия убактысы", "SAST": "Түштүк Африка убактысы", "HNT": "Нюфаундлэнд кышкы убактысы", "LHST": "Лорд Хау кышкы убакыты", "WAST": "Батыш Африка жайкы убактысы", "TMST": "Түркмөнстан жайкы убактысы", "MESZ": "Борбордук Европа жайкы убактысы", "BT": "Бутан убактысы", "UYT": "Уругвай кышкы убактысы"},
	}
}
