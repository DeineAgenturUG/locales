...
func New() locales.Translator {
	return &sr_Latn_BA{
		...
		timezones:              map[string]string{"HEEG": "Источни Гренланд, летње време", "∅∅∅": "Бразилија, летње време", "TMT": "Туркменистан, стандардно време", "TMST": "Туркменистан, летње време", "MST": "Макао стандардно време", "SGT": "Сингапур, стандардно време", "HNT": "Њуфаундленд, стандардно време", "BOT": "Боливија време", "ACDT": "Аустралијско централно летње време", "HAST": "Хавајско-алеутско стандардно време", "ChST": "Чаморо време", "CLT": "Чиле, стандардно време", "WITA": "Централно-индонезијско време", "HNEG": "Источни Гренланд, стандардно време", "AEST": "Аустралијско источно стандардно време", "WIT": "Источно-индонезијско време", "WESZ": "Западноевропско летње време", "ACWST": "Аустралијско централно западно стандардно време", "COT": "Колумбија, стандардно време", "GMT": "Средње време по Гриничу", "AST": "Атлантско стандардно време", "HKT": "Хонг Конг, стандардно време", "WARST": "Западна Аргентина, летње време", "NZDT": "Нови Зеланд, летње време", "IST": "Индијско стандардно време", "EST": "Северноамеричко источно стандардно време", "MYT": "Малезија време", "ADT": "Атлантско летње време", "HEOG": "Западни Гренланд, летње време", "WAT": "Западно-афричко стандардно време", "CLST": "Чиле, летње време", "HNNOMX": "Северозападни Мексико, стандардно време", "NZST": "Нови Зеланд, стандардно време", "HECU": "Куба, летње време", "AKDT": "Аљаска, летње време", "CST": "Северноамеричко централно стандардно време", "LHDT": "Лорд Хов, летње време", "HAT": "Њуфаундленд, летње време", "HNPM": "Сен Пјер и Микелон, стандардно време", "LHST": "Лорд Хов, стандардно време", "OESZ": "Источноевропско летње време", "UYST": "Уругвај, летње време", "WAST": "Западно-афричко летње време", "ACWDT": "Аустралијско централно западно летње време", "JST": "Јапанско стандардно време", "WART": "Западна Аргентина, стандардно време", "HKST": "Хонг Конг, летње време", "HNCU": "Куба, стандардно време", "ACST": "Аустралијско централно стандардно време", "UYT": "Уругвај, стандардно време", "COST": "Колумбија, летње време", "SRT": "Суринам време", "AWST": "Аустралијско западно стандардно време", "HENOMX": "Северозападни Мексико, летње време", "SAST": "Јужно-афричко време", "HEPM": "Сен Пјер и Микелон, летње време", "ECT": "Еквадор време", "AKST": "Аљаска, стандардно време", "MEZ": "Средњеевропско стандардно време", "ART": "Аргентина, стандардно време", "CAT": "Централно-афричко време", "MESZ": "Средњеевропско летње време", "BT": "Бутан време", "CHAST": "Чатам, стандардно време", "GFT": "Француска Гвајана време", "AWDT": "Аустралијско западно летње време", "JDT": "Јапанско летње време", "VET": "Венецуела време", "PDT": "Северноамеричко пацифичко летње време", "CHADT": "Чатам, летње време", "GYT": "Гвајана време", "EAT": "Источно-афричко време", "WEZ": "Западноевропско стандардно време", "WIB": "Западно-индонезијско време", "HEPMX": "Мексички Пацифик, летње време", "MDT": "Макао летње рачунање времена", "HNOG": "Западни Гренланд, стандардно време", "OEZ": "Источноевропско стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "ARST": "Аргентина, летње време", "EDT": "Северноамеричко источно летње време", "HADT": "Хавајско-алеутско летње време", "HNPMX": "Мексички Пацифик, стандардно време", "CDT": "Северноамеричко централно летње време", "AEDT": "Аустралијско источно летње време"},
	}
}
