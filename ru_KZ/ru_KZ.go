...
func New() locales.Translator {
	return &ru_KZ{
		...
		timezones:              map[string]string{"CAT": "Центральная Африка", "HNEG": "Восточная Гренландия, стандарное время", "CDT": "Центральная Америка, летнее время", "HADT": "Гавайско-алеутское летнее время", "WAT": "Западная Африка, стандартное время", "CLST": "Чили, летнее время", "HNOG": "Западная Гренландия, стандартное время", "JDT": "Япония, летнее время", "ACST": "Центральная Австралия, стандартное время", "HNPMX": "Тихоокеанское мексиканское стандартное время", "HKT": "Гонконг, стандартное время", "VET": "Венесуэла", "ACWDT": "Центральная Австралия, западное летнее время", "WEZ": "Западная Европа, стандартное время", "AWST": "Западная Австралия, стандартное время", "SGT": "Сингапур", "TMST": "Туркменистан, летнее время", "PDT": "Тихоокеанское летнее время", "AKST": "Аляска, стандартное время", "AKDT": "Аляска, летнее время", "GMT": "Среднее время по Гринвичу", "JST": "Япония, стандартное время", "PST": "Тихоокеанское стандартное время", "SAST": "Южная Африка", "HEEG": "Восточная Гренландия, летнее время", "HKST": "Гонконг, летнее время", "HNT": "Ньюфаундленд, стандартное время", "ACWST": "Центральная Австралия, западное стандартное время", "HEOG": "Западная Гренландия, летнее время", "LHDT": "Лорд-Хау, летнее время", "BOT": "Боливия", "ART": "Аргентина, стандартное время", "WIB": "Западная Индонезия", "EST": "Восточная Америка, стандартное время", "WAST": "Западная Африка, летнее время", "MST": "Макао, стандартное время", "WITA": "Центральная Индонезия", "HAT": "Ньюфаундленд, летнее время", "WARST": "Западная Аргентина, летнее время", "HNCU": "Куба, стандартное время", "WART": "Западная Аргентина, стандартное время", "HEPM": "Сен-Пьер и Микелон, летнее время", "GYT": "Гайана", "AWDT": "Западная Австралия, летнее время", "EAT": "Восточная Африка", "OEZ": "Восточная Европа, стандартное время", "TMT": "Туркменистан, стандартное время", "BT": "Бутан", "WESZ": "Западная Европа, летнее время", "EDT": "Восточная Америка, летнее время", "LHST": "Лорд-Хау, стандартное время", "∅∅∅": "Бразилия, летнее время", "NZDT": "Новая Зеландия, летнее время", "CHAST": "Чатем, стандартное время", "HAST": "Гавайско-алеутское стандартное время", "UYST": "Уругвай, летнее время", "HENOMX": "Северо-западное мексиканское летнее время", "MYT": "Малайзия", "HNPM": "Сен-Пьер и Микелон, стандартное время", "IST": "Индия", "AST": "Атлантическое стандартное время", "WIT": "Восточная Индонезия", "OESZ": "Восточная Европа, летнее время", "MESZ": "Центральная Европа, летнее время", "ACDT": "Центральная Австралия, летнее время", "GFT": "Французская Гвиана", "ECT": "Эквадор", "ADT": "Атлантическое летнее время", "AEDT": "Восточная Австралия, летнее время", "NZST": "Новая Зеландия, стандартное время", "MEZ": "Центральная Европа, стандартное время", "COT": "Колумбия, стандартное время", "COST": "Колумбия, летнее время", "SRT": "Суринам", "ARST": "Аргентина, летнее время", "CST": "Центральная Америка, стандартное время", "ChST": "Чаморро", "UYT": "Уругвай, стандартное время", "CHADT": "Чатем, летнее время", "HEPMX": "Тихоокеанское мексиканское летнее время", "MDT": "Макао, летнее время", "AEST": "Восточная Австралия, стандартное время", "HECU": "Куба, летнее время", "HNNOMX": "Северо-западное мексиканское стандартное время", "CLT": "Чили, стандартное время"},
	}
}
