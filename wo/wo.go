...
func New() locales.Translator {
	return &wo{
		...
		timezones:              map[string]string{"AKDT": "AKDT", "ACDT": "ACDT", "CHAST": "CHAST", "WAST": "WAST", "HECU": "HECU", "MST": "MST", "AWDT": "AWDT", "EAT": "EAT", "TMT": "TMT", "WARST": "WARST", "HNCU": "HNCU", "CDT": "CDT (waxtu bëccëgu sàntaraal", "HNPMX": "HNPMX", "CAT": "CAT", "ACST": "ACST", "HEEG": "HEEG", "MEZ": "CEST (waxtu estàndaaru ëroop sàntaraal)", "SRT": "SRT", "HNOG": "HNOG", "HADT": "HADT", "UYT": "UYT", "WITA": "WITA", "MESZ": "CEST (waxtu ete wu ëroop sàntaraal)", "GMT": "GMT (waxtu Greenwich)", "AST": "AST (waxtu estàndaaru penku)", "HNT": "HNT", "AWST": "AWST", "TMST": "TMST", "UYST": "UYST", "WAT": "WAT", "GYT": "GYT", "HEOG": "HEOG", "JDT": "JDT", "WART": "WART", "IST": "IST", "EST": "EST (waxtu estàndaaru penku)", "GFT": "GFT", "COT": "COT", "SGT": "SGT", "HENOMX": "HENOMX", "WIB": "WIB", "ChST": "ChST", "HKST": "HKST", "PDT": "PDT (waxtu bëccëgu pasifik)", "BT": "BT", "EDT": "EDT (waxtu bëccëgu penku)", "ADT": "ADT (waxtu bëccëgu atlàntik)", "VET": "VET", "BOT": "BOT", "LHDT": "LHDT", "ECT": "ECT", "AKST": "AKST", "ACWST": "ACWST", "CLT": "CLT", "WIT": "WIT", "ART": "ART", "CHADT": "CHADT", "MYT": "MYT", "∅∅∅": "∅∅∅", "AEST": "AEST", "AEDT": "AEDT", "CST": "CST (waxtu estàndaaru sàntaraal)", "ACWDT": "ACWDT", "SAST": "SAST", "MDT": "MDT", "HKT": "HKT", "OESZ": "EEST (waxtu ete wu ëroop u penku)", "HNEG": "HNEG", "ARST": "ARST", "HEPM": "HEPM", "CLST": "CLST", "OEZ": "EEST (waxtu estàndaaru ëroop u penku)", "HAST": "HAST", "COST": "COST", "HEPMX": "HEPMX", "JST": "JST", "NZDT": "NZDT", "PST": "PST (waxtu estàndaaru pasifik)", "WEZ": "WEST (waxtu estàndaaru ëroop u sowwu-jant)", "WESZ": "WEST (waxtu ete wu ëroop u sowwu-jant)", "HNNOMX": "HNNOMX", "HAT": "HAT", "HNPM": "HNPM", "LHST": "LHST", "NZST": "NZST"},
	}
}
