...
func New() locales.Translator {
	return &kk{
		...
		timezones:              map[string]string{"WEZ": "Батыс Еуропа стандартты уақыты", "HNPMX": "Мексика стандартты Тынық мұхит уақыты", "ACWDT": "Австралия жазғы орталық-батыс уақыты", "HNOG": "Батыс Гренландия стандартты уақыты", "TMST": "Түрікменстан жазғы уақыты", "EAT": "Шығыс Африка уақыты", "OEZ": "Шығыс Еуропа стандартты уақыты", "MESZ": "Орталық Еуропа жазғы уақыты", "WARST": "Батыс Аргентина жазғы уақыты", "SGT": "Сингапур стандартты уақыты", "TMT": "Түрікменстан стандартты уақыты", "HEEG": "Шығыс Гренландия жазғы уақыты", "COST": "Колумбия жазғы уақыты", "GYT": "Гайана уақыты", "ACWST": "Австралия стандартты орталық-батыс уақыты", "IST": "Үндістан стандартты уақыты", "LHDT": "Лорд-Хау жазғы уақыты", "ARST": "Аргентина жазғы уақыты", "HNT": "Ньюфаундленд стандартты уақыты", "SAST": "Оңтүстік Африка уақыты", "GFT": "Француз Гвианасы уақыты", "HEPMX": "Мексика жазғы Тынық мұхит уақыты", "HKST": "Гонконг жазғы уақыты", "ChST": "Чаморро стандартты уақыты", "CAT": "Орталық Африка уақыты", "WAT": "Батыс Африка стандартты уақыты", "SRT": "Суринам уақыты", "AEDT": "Австралия жазғы шығыс уақыты", "WART": "Батыс Аргентина стандартты уақыты", "HNNOMX": "Солтүстік-батыс Мексика стандартты уақыты", "PST": "Солтүстік Америка стандартты Тынық мұхиты уақыты", "BOT": "Боливия уақыты", "WAST": "Батыс Африка жазғы уақыты", "CLT": "Чили стандартты уақыты", "GMT": "Гринвич уақыты", "ADT": "Атлантика жазғы уақыты", "UYST": "Уругвай жазғы уақыты", "UYT": "Уругвай стандартты уақыты", "MST": "MST", "HKT": "Гонконг стандартты уақыты", "NZST": "Жаңа Зеландия стандартты уақыты", "LHST": "Лорд-Хау стандартты уақыты", "AEST": "Австралия стандартты шығыс уақыты", "JDT": "Жапония жазғы уақыты", "NZDT": "Жаңа Зеландия жазғы уақыты", "MEZ": "Орталық Еуропа стандартты уақыты", "AKST": "Аляска стандартты уақыты", "AKDT": "Аляска жазғы уақыты", "WESZ": "Батыс Еуропа жазғы уақыты", "WIB": "Батыс Индонезия уақыты", "PDT": "Солтүстік Америка жазғы Тынық мұхиты уақыты", "HAT": "Ньюфаундленд жазғы уақыты", "EDT": "Солтүстік Америка жазғы шығыс уақыты", "COT": "Колумбия стандартты уақыты", "MDT": "MDT", "OESZ": "Шығыс Еуропа жазғы уақыты", "HECU": "Куба жазғы уақыты", "CST": "Солтүстік Америка стандартты орталық уақыты", "HNPM": "Сен-Пьер және Микелон стандартты уақыты", "ACDT": "Австралия жазғы орталық уақыты", "CHAST": "Чатем стандартты уақыты", "CDT": "Солтүстік Америка жазғы орталық уақыты", "MYT": "Малайзия уақыты", "CLST": "Чили жазғы уақыты", "AWST": "Австралия стандартты батыс уақыты", "ART": "Аргентина стандартты уақыты", "VET": "Венесуэла уақыты", "JST": "Жапония стандартты уақыты", "EST": "Солтүстік Америка стандартты шығыс уақыты", "ECT": "Эквадор уақыты", "AWDT": "Австралия жазғы батыс уақыты", "WITA": "Орталық Индонезия уақыты", "HNCU": "Куба стандартты уақыты", "HNEG": "Шығыс Гренландия стандартты уақыты", "BT": "Бутан уақыты", "ACST": "Австралия стандартты орталық уақыты", "CHADT": "Чатем жазғы уақыты", "∅∅∅": "Бразилия жазғы уақыты", "HAST": "Гавай және Алеут аралдары стандартты уақыты", "HADT": "Гавай және Алеут аралдары жазғы уақыты", "AST": "Атлантика стандартты уақыты", "HEPM": "Сен-Пьер және Микелон жазғы уақыты", "WIT": "Шығыс Индонезия уақыты", "HENOMX": "Солтүстік-батыс Мексика жазғы уақыты", "HEOG": "Батыс Гренландия жазғы уақыты"},
	}
}
