...
func New() locales.Translator {
	return &os{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"COST": "COST", "MDT": "MDT", "AEDT": "AEDT", "AWDT": "AWDT", "OEZ": "Скӕсӕн Европӕйаг стандартон рӕстӕг", "HNNOMX": "HNNOMX", "HENOMX": "HENOMX", "ACWDT": "ACWDT", "WEZ": "Ныгъуылӕн Европӕйаг стандартон рӕстӕг", "EDT": "EDT", "MEZ": "Астӕуккаг Европӕйаг стандартон рӕстӕг", "MST": "MST", "JST": "JST", "CHADT": "CHADT", "CLST": "CLST", "NZST": "NZST", "HNEG": "HNEG", "ARST": "ARST", "HNPM": "HNPM", "HKT": "HKT", "CDT": "CDT", "MYT": "MYT", "JDT": "JDT", "WARST": "WARST", "HAST": "HAST", "GFT": "GFT", "AWST": "AWST", "TMST": "TMST", "HNT": "HNT", "HEEG": "HEEG", "AKST": "AKST", "ChST": "ChST", "UYST": "UYST", "WAT": "WAT", "WIT": "WIT", "HAT": "HAT", "BOT": "BOT", "IST": "IST", "LHDT": "LHDT", "HEPMX": "HEPMX", "AST": "AST", "HEOG": "HEOG", "HKST": "HKST", "SGT": "SGT", "OESZ": "Скӕсӕн Европӕйаг сӕрдыгон рӕстӕг", "WESZ": "Ныгъуылӕн Европӕйаг сӕрдыгон рӕстӕг", "COT": "COT", "AEST": "AEST", "WITA": "WITA", "WART": "WART", "BT": "BT", "CST": "CST", "WAST": "WAST", "PST": "PST", "PDT": "PDT", "ECT": "ECT", "EAT": "EAT", "ART": "ART", "SRT": "SRT", "∅∅∅": "∅∅∅", "TMT": "TMT", "NZDT": "NZDT", "HECU": "HECU", "AKDT": "AKDT", "MESZ": "Астӕуккаг Европӕйаг сӕрдыгон рӕстӕг", "EST": "EST", "GYT": "GYT", "GMT": "Гринвичы рӕстӕмбис рӕстӕг", "ACDT": "ACDT", "CHAST": "CHAST", "ACWST": "ACWST", "LHST": "LHST", "HADT": "HADT", "HNCU": "HNCU", "ADT": "ADT", "HNOG": "HNOG", "VET": "VET", "SAST": "SAST", "CLT": "CLT", "CAT": "CAT", "ACST": "ACST", "HEPM": "HEPM", "WIB": "WIB", "UYT": "UYT", "HNPMX": "HNPMX"},
	}
}
