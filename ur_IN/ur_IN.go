...
func New() locales.Translator {
	return &ur_IN{
		...
		timezones:              map[string]string{"CHADT": "چیتھم ڈے لائٹ ٹائم", "HNPM": "سینٹ پیئر اور مکلیئون اسٹینڈرڈ ٹائم", "HEPM": "سینٹ پیئر اور مکلیئون ڈے لائٹ ٹائم", "EDT": "ایسٹرن ڈے لائٹ ٹائم", "HNNOMX": "شمال مغربی میکسیکو اسٹینڈرڈ ٹائم", "SAST": "جنوبی افریقہ سٹینڈرڈ ٹائم", "ARST": "ارجنٹینا سمر ٹائم", "EAT": "مشرقی افریقہ ٹائم", "HKST": "ہانگ کانگ سمر ٹائم", "WIT": "مشرقی انڈونیشیا ٹائم", "AKDT": "الاسکا ڈے لائٹ ٹائم", "IST": "انڈیا سٹینڈرڈ ٹائم", "ACWST": "آسٹریلین سنٹرل ویسٹرن اسٹینڈرڈ ٹائم", "COT": "کولمبیا سٹینڈرڈ ٹائم", "ADT": "اٹلانٹک ڈے لائٹ ٹائم", "HEOG": "مغربی گرین لینڈ کا موسم گرما کا وقت", "WART": "مغربی ارجنٹینا سٹینڈرڈ ٹائم", "CST": "سنٹرل اسٹینڈرڈ ٹائم", "CDT": "سنٹرل ڈے لائٹ ٹائم", "GMT": "گرین وچ مین ٹائم", "WITA": "وسطی انڈونیشیا ٹائم", "WIB": "مغربی انڈونیشیا ٹائم", "EST": "ایسٹرن اسٹینڈرڈ ٹائم", "UYT": "یوروگوئے سٹینڈرڈ ٹائم", "WAST": "مغربی افریقہ سمر ٹائم", "OEZ": "مشرقی یورپ کا معیاری وقت", "PST": "پیسفک اسٹینڈرڈ ٹائم", "MEZ": "وسطی یورپ کا معیاری وقت", "HAST": "ہوائی الیوٹیئن اسٹینڈرڈ ٹائم", "GYT": "گیانا ٹائم", "MST": "MST", "MDT": "MDT", "TMST": "ترکمانستان سمر ٹائم", "∅∅∅": "برازیلیا سمر ٹائم", "SRT": "سورینام ٹائم", "AEST": "آسٹریلین ایسٹرن اسٹینڈرڈ ٹائم", "JST": "جاپان سٹینڈرڈ ٹائم", "TMT": "ترکمانستان سٹینڈرڈ ٹائم", "BOT": "بولیویا ٹائم", "AST": "اٹلانٹک اسٹینڈرڈ ٹائم", "VET": "وینزوئیلا ٹائم", "HECU": "کیوبا ڈے لائٹ ٹائم", "HNEG": "مشرقی گرین لینڈ اسٹینڈرڈ ٹائم", "WEZ": "مغربی یورپ کا معیاری وقت", "ChST": "چامورو سٹینڈرڈ ٹائم", "WAT": "مغربی افریقہ سٹینڈرڈ ٹائم", "JDT": "جاپان ڈے لائٹ ٹائم", "WARST": "مغربی ارجنٹینا سمر ٹائم", "COST": "کولمبیا سمر ٹائم", "ART": "ارجنٹینا سٹینڈرڈ ٹائم", "ACDT": "آسٹریلین سنٹرل ڈے لائٹ ٹائم", "WESZ": "مغربی یورپ کا موسم گرما کا وقت", "HADT": "ہوائی الیوٹیئن ڈے لائٹ ٹائم", "UYST": "یوروگوئے سمر ٹائم", "CLST": "چلی سمر ٹائم", "AKST": "الاسکا اسٹینڈرڈ ٹائم", "ECT": "ایکواڈور ٹائم", "HNOG": "مغربی گرین لینڈ اسٹینڈرڈ ٹائم", "AWST": "آسٹریلیا ویسٹرن اسٹینڈرڈ ٹائم", "AWDT": "آسٹریلین ویسٹرن ڈے لائٹ ٹائم", "MESZ": "وسطی یورپ کا موسم گرما کا وقت", "ACST": "آسٹریلین سنٹرل اسٹینڈرڈ ٹائم", "CHAST": "چیتھم اسٹینڈرڈ ٹائم", "ACWDT": "آسٹریلین سنٹرل ویسٹرن ڈے لائٹ ٹائم", "CLT": "چلی سٹینڈرڈ ٹائم", "OESZ": "مشرقی یورپ کا موسم گرما کا وقت", "HEEG": "مشرقی گرین لینڈ کا موسم گرما کا وقت", "LHST": "لارڈ ہووے اسٹینڈرڈ ٹائم", "LHDT": "لارڈ ہووے ڈے لائٹ ٹائم", "MYT": "ملیشیا ٹائم", "AEDT": "آسٹریلین ایسٹرن ڈے لائٹ ٹائم", "HKT": "ہانگ کانگ سٹینڈرڈ ٹائم", "HNT": "نیو فاؤنڈ لینڈ اسٹینڈرڈ ٹائم", "PDT": "پیسفک ڈے لائٹ ٹائم", "BT": "بھوٹان ٹائم", "GFT": "فرینچ گیانا ٹائم", "SGT": "سنگاپور سٹینڈرڈ ٹائم", "NZST": "نیوزی لینڈ سٹینڈرڈ ٹائم", "HNCU": "کیوبا اسٹینڈرڈ ٹائم", "HENOMX": "شمال مغربی میکسیکو ڈے لائٹ ٹائم", "CAT": "وسطی افریقہ ٹائم", "HNPMX": "میکسیکن پیسفک اسٹینڈرڈ ٹائم", "HEPMX": "میکسیکن پیسفک ڈے لائٹ ٹائم", "NZDT": "نیوزی لینڈ ڈے لائٹ ٹائم", "HAT": "نیو فاؤنڈ لینڈ ڈے لائٹ ٹائم"},
	}
}
