...
func New() locales.Translator {
	return &be_BY{
		...
		timezones:              map[string]string{"LHDT": "Летні час Лорд-Хау", "ADT": "Атлантычны летні час", "HNNOMX": "Паўночна-заходні мексіканскі стандартны час", "CLT": "Чылійскі стандартны час", "COST": "Калумбійскі летні час", "HENOMX": "Паўночна-заходні мексіканскі летні час", "ACWST": "Стандартны цэнтральна-заходні час Аўстраліі", "HNPMX": "Мексіканскі ціхаакіянскі стандатны час", "AEST": "Стандартны час усходняй Аўстраліі", "WARST": "Летні час Заходняй Аргенціны", "NZST": "Стандартны час Новай Зеландыі", "HEEG": "Летні час Усходняй Грэнландыі", "EST": "Паўночнаамерыканскі ўсходні стандартны час", "WAT": "Заходнеафрыканскі стандартны час", "HNOG": "Стандартны час Заходняй Грэнландыі", "EAT": "Усходнеафрыканскі час", "UYST": "Уругвайскі летні час", "CLST": "Чылійскі летні час", "WIT": "Усходнеінданезійскі час", "∅∅∅": "Бразільскі летні час", "HADT": "Гавайска-Алеуцкі летні час", "GMT": "Час па Грынвічы", "JDT": "Летні час Японіі", "WEZ": "Заходнееўрапейскі стандартны час", "SAST": "Паўднёваафрыканскі час", "MYT": "Час Малайзіі", "GYT": "Час Гаяны", "MDT": "MDT", "SGT": "Сінгапурскі час", "WITA": "Цэнтральнаінданезійскі час", "JST": "Стандартны час Японіі", "HECU": "Летні час Кубы", "AKST": "Стандартны час Аляскі", "ARST": "Аргенцінскі летні час", "HEPM": "Стандартны летні час Сен-П’ер і Мікелон", "CST": "Паўночнаамерыканскі цэнтральны стандартны час", "ChST": "Час Чамора", "SRT": "Час Сурынама", "HKST": "Летні час Ганконга", "TMT": "Стандартны час Туркменістана", "TMST": "Летні час Туркменістана", "CHAST": "Стандартны час Чатэма", "HEOG": "Летні час Заходняй Грэнландыі", "OESZ": "Усходнееўрапейскі летні час", "HNCU": "Стандартны час Кубы", "MESZ": "Цэнтральнаеўрапейскі летні час", "CAT": "Цэнтральнаафрыканскі час", "CDT": "Паўночнаамерыканскі цэнтральны летні час", "WIB": "Заходнеінданезійскі час", "UYT": "Уругвайскі стандартны час", "COT": "Калумбійскі стандартны час", "HAT": "Ньюфаўндлендскі летні час", "HNT": "Ньюфаўндлендскі стандартны час", "WAST": "Заходнеафрыканскі летні час", "HEPMX": "Мексіканскі ціхаакіянскі летні час", "AWDT": "Летні час заходняй Аўстраліі", "HKT": "Стандартны час Ганконга", "OEZ": "Усходнееўрапейскі стандартны час", "VET": "Венесуэльскі час", "PST": "Ціхаакіянскі стандартны час", "BOT": "Балівійскі час", "AKDT": "Летні час Аляскі", "ART": "Аргенцінскі стандартны час", "HNPM": "Стандартны час Сен-П’ер і Мікелон", "MST": "MST", "ACDT": "Летні час цэнтральнай Аўстраліі", "IST": "Час Індыі", "GFT": "Час Французскай Гвіяны", "ACWDT": "Летні цэнтральна-заходні час Аўстраліі", "AST": "Атлантычны стандартны час", "AEDT": "Летні час усходняй Аўстраліі", "AWST": "Стандартны час заходняй Аўстраліі", "PDT": "Ціхаакіянскі летні час", "CHADT": "Летні час Чатэма", "EDT": "Паўночнаамерыканскі ўсходні летні час", "ECT": "Эквадорскі час", "ACST": "Стандартны час цэнтральнай Аўстраліі", "LHST": "Стандартны час Лорд-Хау", "HAST": "Гавайска-Алеуцкі стандартны час", "WART": "Стандартны час Заходняй Аргенціны", "NZDT": "Летні час Новай Зеландыі", "HNEG": "Стандартны час Усходняй Грэнландыі", "MEZ": "Цэнтральнаеўрапейскі стандартны час", "BT": "Час Бутана", "WESZ": "Заходнееўрапейскі летні час"},
	}
}
