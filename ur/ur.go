...
func New() locales.Translator {
	return &ur{
		...
		timezones:          map[string]string{"HENOMX": "شمال مغربی میکسیکو ڈے لائٹ ٹائم", "SAST": "جنوبی افریقہ سٹینڈرڈ ٹائم", "AKDT": "الاسکا ڈے لائٹ ٹائم", "WEZ": "مغربی یورپ کا معیاری وقت", "COT": "کولمبیا کا معیاری وقت", "HEOG": "مغربی گرین لینڈ کا موسم گرما کا وقت", "HKST": "ہانگ کانگ سمر ٹائم", "TMST": "ترکمانستان کا موسم گرما کا وقت", "WITA": "وسطی انڈونیشیا ٹائم", "JDT": "جاپان ڈے لائٹ ٹائم", "ARST": "ارجنٹینا سمر ٹائم", "CHAST": "چیتھم اسٹینڈرڈ ٹائم", "∅∅∅": "برازیلیا سمر ٹائم", "LHST": "لارڈ ہووے اسٹینڈرڈ ٹائم", "MYT": "ملیشیا ٹائم", "WART": "مغربی ارجنٹینا کا معیاری وقت", "PDT": "پیسفک ڈے لائٹ ٹائم", "WIT": "مشرقی انڈونیشیا ٹائم", "ACST": "آسٹریلین سنٹرل اسٹینڈرڈ ٹائم", "CHADT": "چیتھم ڈے لائٹ ٹائم", "GFT": "فرینچ گیانا کا وقت", "HEPMX": "میکسیکن پیسفک ڈے لائٹ ٹائم", "ADT": "اٹلانٹک ڈے لائٹ ٹائم", "COST": "کولمبیا کا موسم گرما کا وقت", "PST": "پیسفک اسٹینڈرڈ ٹائم", "HNEG": "مشرقی گرین لینڈ اسٹینڈرڈ ٹائم", "HKT": "ہانگ کانگ سٹینڈرڈ ٹائم", "HEEG": "مشرقی گرین لینڈ کا موسم گرما کا وقت", "AKST": "الاسکا اسٹینڈرڈ ٹائم", "MESZ": "وسطی یورپ کا موسم گرما کا وقت", "HAST": "ہوائی الیوٹیئن اسٹینڈرڈ ٹائم", "ChST": "چامورو سٹینڈرڈ ٹائم", "CLST": "چلی کا موسم گرما کا وقت", "OEZ": "مشرقی یورپ کا معیاری وقت", "HNPM": "سینٹ پیئر اور مکلیئون اسٹینڈرڈ ٹائم", "CDT": "سنٹرل ڈے لائٹ ٹائم", "SRT": "سورینام کا وقت", "MDT": "MDT", "AST": "اٹلانٹک اسٹینڈرڈ ٹائم", "BT": "بھوٹان کا وقت", "IST": "ہندوستان کا معیاری وقت", "UYT": "یوروگوئے کا معیاری وقت", "CLT": "چلی کا معیاری وقت", "HECU": "کیوبا ڈے لائٹ ٹائم", "HNOG": "مغربی گرین لینڈ اسٹینڈرڈ ٹائم", "AWDT": "آسٹریلین ویسٹرن ڈے لائٹ ٹائم", "ART": "ارجنٹینا سٹینڈرڈ ٹائم", "CAT": "وسطی افریقہ ٹائم", "CST": "سنٹرل اسٹینڈرڈ ٹائم", "WAT": "مغربی افریقہ سٹینڈرڈ ٹائم", "ECT": "ایکواڈور کا وقت", "WESZ": "مغربی یورپ کا موسم گرما کا وقت", "EDT": "ایسٹرن ڈے لائٹ ٹائم", "HNPMX": "میکسیکن پیسفک اسٹینڈرڈ ٹائم", "OESZ": "مشرقی یورپ کا موسم گرما کا وقت", "JST": "جاپان سٹینڈرڈ ٹائم", "AEDT": "آسٹریلین ایسٹرن ڈے لائٹ ٹائم", "WARST": "مغربی ارجنٹینا کا موسم گرما کا وقت", "NZDT": "نیوزی لینڈ ڈے لائٹ ٹائم", "BOT": "بولیویا کا وقت", "MEZ": "وسطی یورپ کا معیاری وقت", "ACDT": "آسٹریلین سنٹرل ڈے لائٹ ٹائم", "GMT": "گرین وچ کا اصل وقت", "GYT": "گیانا کا وقت", "HNNOMX": "شمال مغربی میکسیکو اسٹینڈرڈ ٹائم", "EAT": "مشرقی افریقہ ٹائم", "NZST": "نیوزی لینڈ کا معیاری وقت", "HNCU": "کیوبا اسٹینڈرڈ ٹائم", "EST": "ایسٹرن اسٹینڈرڈ ٹائم", "WAST": "مغربی افریقہ سمر ٹائم", "ACWDT": "آسٹریلین سنٹرل ویسٹرن ڈے لائٹ ٹائم", "AEST": "آسٹریلین ایسٹرن اسٹینڈرڈ ٹائم", "TMT": "ترکمانستان کا معیاری وقت", "HAT": "نیو فاؤنڈ لینڈ ڈے لائٹ ٹائم", "WIB": "مغربی انڈونیشیا ٹائم", "HNT": "نیو فاؤنڈ لینڈ اسٹینڈرڈ ٹائم", "HEPM": "سینٹ پیئر اور مکلیئون ڈے لائٹ ٹائم", "LHDT": "لارڈ ہووے ڈے لائٹ ٹائم", "UYST": "یوروگوئے کا موسم گرما کا وقت", "AWST": "آسٹریلیا ویسٹرن اسٹینڈرڈ ٹائم", "VET": "وینزوئیلا کا وقت", "HADT": "ہوائی الیوٹیئن ڈے لائٹ ٹائم", "ACWST": "آسٹریلین سنٹرل ویسٹرن اسٹینڈرڈ ٹائم", "MST": "MST", "SGT": "سنگاپور سٹینڈرڈ ٹائم"},
	}
}
